            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <p class="ts-reason-card-description">We believe in providing hassle free and convenient tour booking options to our guests. Tour enquiries / booking can be done through our websites. And can send us e-mail directly to get a prompt reply.</p>
            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <p class="ts-reason-card-description">We understand our guests needs to perfection and thus provide them with flexible customized holiday packages according to their needs are requirements.</p>
            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <p class="ts-reason-card-description">Our travel consultants carry years of experience in the travel industry and consists of travel enthusiasts who themselves are travel buffs.</p>
            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <p class="ts-reason-card-description">We are available for our guests any day of the week. With our highly trained operations team, we keep a look out for even the most minute of issues.</p>
