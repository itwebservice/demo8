    ...
    <div class="c-cardListTable">
      ...
      <div class="cardList-info" role="button">
        ...
        <div class="dividerSection type-1 noborder">
          <div class="divider s1" role="button" data-toggle="collapse" href="#collapseExample<?= $tours_result_array[$i]['tour_id']?>"
      ...
      <div class="cardList-accordian">
        ...
        <div class="c-compTabs">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="itinerary-tab" data-toggle="tab" href="#itinerary-tab<?= $tours_result_array[$i]['tour_id']?>" role="tab"
                aria-controls="itinerary" aria-selected="true">Itinerary</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="travel-tab" data-toggle="tab" href="#travel-tab<?= $tours_result_array[$i]['tour_id']?>" role="tab"
                aria-controls="travel" aria-selected="true">Travel & Stay</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="inclusion-tab" data-toggle="tab" href="#inclusion-tab<?= $tours_result_array[$i]['tour_id']?>" role="tab"
                aria-controls="inclusion" aria-selected="true">INCLUSIONS/EXCLUSIONS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="costing-tab" data-toggle="tab" href="#costing-tab<?= $tours_result_array[$i]['tour_id']?>" role="tab"
