...
.div_left.type-02 .nav-pills>li{border: 1px dotted #ccc; padding-right: 0px;}
.div_left.type-02 .dropdown.active a{background-color : #eee!important; color:<?= $theme_color ?>;padding-left: 25px;
}
.div_left.type-02 .nav-pills>li>a{font-size: 12px; line-height: 16px; font-weight: 500;padding-left: 25px;}
