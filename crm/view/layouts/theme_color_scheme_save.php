...
<div class="modal fade" id="app_color_scheme_modal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" >
      ...
      submitHandler:function(data){
          ...
          $.ajax({
            ...
            success:function(result){
              ...
              $('#app_color_scheme_modal').modal('hide');
