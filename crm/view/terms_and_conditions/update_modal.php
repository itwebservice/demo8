...
$(function(){
  $('#frm_update').validate({
    ...
    submitHandler:function(form){
        ...
        console.log($('#terms_and_conditions_id'));
        ...
        $.post(
               ...
               { type : type,terms_and_conditions_id : terms_and_conditions_id,  terms_and_conditions : terms_and_conditions, active_flag : active_flag,dest_id:dest_id },
               function(data) {
