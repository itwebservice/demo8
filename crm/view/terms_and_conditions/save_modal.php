    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row mg_bt_20">
          <div class="col-md-6">
            <select id="type1" name="type" style="width: 100%;" title="Select Type" onchange="get_dest_dropdown(this.id)">
          ...
          <div class="col-md-6" id="dest_html">
          </div>
        </div>
	  	  ...
	  	  <div class="row">
	  	  	<div class="col-md-12">
	  	  		...
	  	  		<textarea class="feature_editor" name="terms_and_conditions" id="terms_and_conditions" style="width:100% !important" rows="15" onchange="validate_terms_conditions(this.id);"></textarea>
	  	  	</div>
	  	  </div>
...
$(function(){
  $('#frm_save').validate({
    ...
    submitHandler:function(form){
        ...
        var flag1 = validate_terms_conditions('terms_and_conditions');
        if(!flag1){
            return false;
        }
        ...
        $.post(
              ...
              { type : type, terms_and_conditions : terms_and_conditions, active_flag : active_flag, branch_admin_id : branch_admin_id ,dest_id:dest_id},
              function(data) {
