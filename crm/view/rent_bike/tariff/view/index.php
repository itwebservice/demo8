	...
	<div class="modal-dialog modal-lg" role="document">
		...
		<div class="modal-body profile_box_padding">
			<div>
				...
				<li role="presentation"><a href="#offer_information" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">Offers/Coupons</a></li>
				...
				<div class="tab-content responsive">
					...
					<!-- ********Tab1 End******** -->
					<!-- *****TAb1 start -->
					<div role="tabpanel" class="tab-pane no-pad-sm" id="offer_information">
