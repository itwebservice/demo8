						...
						<div id="collapse1" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading1">
							<div class="panel-body">
								<div class="row mg_bt_10">
									...
									<div class="col-sm-2">
										<input type="text" id="service_name" name="service_name" placeholder="*Activity Name" title="Activity Name" onkeypress="return blockSpecialChar(event);">
									</div>
									<div class="col-sm-2">
...
$('#to_date,#from_date,#from_date_basic,#to_date_basic').datetimepicker({ timepicker:false, format:'d-m-Y' });
...
$(function(){
	$('#frm_b2b_exc_save').validate({
		...
		submitHandler:function(form){
			...
			if(bfrom_date_array.length == 0){ error_msg_alert('Atlease one row required in Basic Costing!'); return false;}
