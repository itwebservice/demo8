...
$sq_exc = mysqli_fetch_assoc(mysqlQuery("select timing_slots from excursion_master_tariff where entry_id='$entry_id'"));
		...
		<div class="col-md-12">
			<div class="table-responsive">
				...
				<?php }
					...
					<tr>
						<td><input class="css-checkbox" id="chk_time<?=$i?>-u" type="checkbox" checked><label class="css-label" for="chk_basic"> </label></td>
