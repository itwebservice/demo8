...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='package_booking/payments/index.php'"));
...
<div class="app_panel_content Filter-panel">
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                <select name="cust_type_filter" id="cust_type_filter" style="width:100%" onchange="dynamic_customer_load1(this.value,'company_filter');company_name_reflect();" title="Customer Type">
                    <?php get_customer_type_dropdown(); ?>
                </select>
        </div>
        <div id="company_div" class="hidden">
        </div>
    	<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10" id="customer_div1">
        </div> 
    	<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
function dynamic_customer_load1(cust_type, company_name)
{   
    alert('hi');
    var cust_type = $('#cust_type_filter').val();
    var company_name = $('#company_filter').val();
