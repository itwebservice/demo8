...
?>
<div class="modal fade" id="view_log_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					for($i=0; strtotime($from_date)<=strtotime($to_date); $i++){
						...
						$count++;
						$q1 = mysqlQuery("select log_id, min(login_time) as login_time, status, remark, user_ip from user_logs where login_date='$from_date' and login_id='$login_id'");
						$sq_log = mysqli_fetch_assoc($q1);
