...
<div class="row"> <div class="col-md-12 no-pad"> <div class="table-responsive">
	...
	<table class="table table-hover no-marg-sm" id="tbl_att_list">
		...
		<tbody>
			...
			++$count;
			$sq_att= mysqli_fetch_assoc(mysqlQuery("select * from employee_attendance_log where att_date='$attendence_date' and emp_id='$row_emp[emp_id]'"));
	...
	<input type="hidden" value="<?= date('d-m-Y')?>" id="cur_date"/>
