       ...
       <legend>Official Information</legend>
        ...
        <div class="row text-center mg_tp_10">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <select name="location_idu" id="location_idu" title="Location" onchange="branch_name_load()">                    
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <select class="form-control" id="branch_idu" name="branch_idu" title="Branch" onchange="address_reflect()">                    
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <select class="form-control" id="role_id1" name="role_id1" onchange="select_color(this.id)" title="Role" <?=$status ?>>
...
$('#frm_tab1_u').validate({
	...
	rules:{
            ...
            location_idu : { required : true },

            branch_idu : { required : true },
