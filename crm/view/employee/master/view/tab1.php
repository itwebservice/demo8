	...
	<div class="col-md-12">
		...
		<div class="panel panel-default panel-body app_panel_style">
			<div class="profile_box main_block">
        	 	...
        	 	<?php 
					$count = 0;
					$sq_emp = mysqli_fetch_assoc(mysqlQuery($query));
        	 	?>
	...
	<div class="col-md-12 mg_tp_10">
		...
		<div class="panel panel-default panel-body app_panel_style">
            ...
            <?php  
             ...
             $sq_location = mysqli_fetch_assoc(mysqlQuery("select * from locations where location_id='$sq_emp[location_id]'"));

		   	 $sq_branch = mysqli_fetch_assoc(mysqlQuery("select * from branches where branch_id='$sq_emp[branch_id]'"));

			 $sq_login = mysqli_fetch_assoc(mysqlQuery("select * from roles where emp_id='$sq_emp[emp_id]'"));
	        ...
	        <div class="row">
	        	...
	        	<div class="col-md-6">
					...
					<?php 
						...
						$query_role = mysqli_fetch_assoc(mysqlQuery("select * from role_master where role_id = '$sq_emp[role_id]'")); 
	                ...
	                <span class="main_block">
	                  ...
	                  <?php echo "<label>ID Proof <em>:</em></label> "?><a href="<?php echo $newUrl; ?>" download title="Download ID Proof"><i class="fa fa-id-card-o"></i></a> 
