...
$sq_credit = mysqli_fetch_assoc(mysqlQuery("select * from b2b_creditlimit_master where entry_id='$entry_id'"));
?>
<div class="modal fade" id="credit_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
