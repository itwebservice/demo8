...
$sq_refund_amount = mysqli_fetch_assoc(mysqlQuery("select sum(refund_amount)as sum from train_ticket_refund_master where train_ticket_id='$ticket_id' and clearance_status!='Pending' and clearance_status!='Cancelled'"));

$sq_refund_pen_amount = mysqli_fetch_assoc(mysqlQuery("select sum(refund_amount)as sum from train_ticket_refund_master where train_ticket_id='$ticket_id' and clearance_status='Pending'"));
