...
$sq_hotel_nm = mysqli_fetch_assoc(mysqlQuery("select * from hotel_master where hotel_id='$hotel_id'"));
$hotel=$sq_hotel_nm['hotel_name'];
$sq_img = mysqlQuery("SELECT * from hotel_vendor_images_entries where hotel_id='$hotel_id'");
$counter=0;
$slides='';
$Indicators='';
while($row=mysqli_fetch_array($sq_img))
{
