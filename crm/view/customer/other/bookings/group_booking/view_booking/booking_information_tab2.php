...
<div class="panel panel-default panel-body pad_8 mg_bt_10 customer_pan">
	...
	<div class="row"> <div class="col-md-12"> <div class="table-responsive">
		<?php 
			$sq_train_count = mysqli_num_rows(mysqlQuery("select train_id from train_master where tourwise_traveler_id='$tourwise_id'"));
			...
			if($sq_train_count>0)
			{
			 ...
			 <?php   
			    ...
			    $train_count=0;
			    $sq_train = mysqlQuery("select * from train_master where tourwise_traveler_id='$tourwise_id'");
			    ...
			    {			        
			     ...
			     <tr>
			     	...
			     	<td><?php echo date("d-m-Y H:i", strtotime($row_train['date'])) ?></td>
...
<div class="panel panel-default panel-body pad_8 mg_bt_10 customer_pan">
	...
	<div class="row"> <div class="col-md-12"> <div class="table-responsive">
	    <?php
	    $sq_plane_count = mysqli_num_rows(mysqlQuery("select plane_id from plane_master where tourwise_traveler_id='$tourwise_id'"));
		...
		if($sq_plane_count>0)
		{
		    ...
		    $plane_count=0;
		    $sq_train = mysqlQuery("select * from plane_master where tourwise_traveler_id='$tourwise_id'");
		    while($row_plane = mysqli_fetch_assoc($sq_train))
		    {
		    	$plane_count++;
		    ?>
		    	<tr>
		    		<td><?php echo $plane_count ?></td>
		    		<td><?php echo date("d-m-Y H:i", strtotime($row_plane['date'])) ?></td>
		    		<td><?php echo $row_plane['from_location'] ?></td>
		    		<td><?php echo $row_plane['to_location'] ?></td>
		    		<td><?php echo $row_plane['company'] ?></td>
		    		<td><?php echo date("d-m-Y H:i", strtotime($row_plane['arraval_time'])) ?></td>
