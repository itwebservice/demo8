...
<div class="panel panel-default panel-body pad_8 mg_bt_10 customer_pan">
	...
	<div class="row"> <div class="col-md-12"> <div class="table-responsive">
		<table class="table table-bordered table-hover mg_bt_10">
            ...
            $count=0;
            $bg;
            $sq_traveler_info = mysqlQuery("select * from travelers_details where traveler_group_id='$traveler_group_id'");
            while($row_traveler_info = mysqli_fetch_assoc($sq_traveler_info))
            {
                $count++;
...
<?php 
$traveler_personal_details = mysqli_fetch_assoc(mysqlQuery("select * from traveler_personal_info where tourwise_traveler_id='$tourwise_id'"));
