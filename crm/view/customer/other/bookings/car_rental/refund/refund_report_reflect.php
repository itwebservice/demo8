...
$sq_refund_pen_info = mysqli_fetch_assoc(mysqlQuery("select sum(refund_amount) as sum from car_rental_refund_master where booking_id='$booking_id' and clearance_status='Pending'"));
