		...
		<div class="row">
			<div class="col-md-3">
				<select name="passport_id1" id="passport_id1" style="width:100%" onchange="refund_report_reflect()">
			        ...
			        <?php 
			        $sq_passport = mysqlQuery("select * from passport_master where customer_id='$customer_id' and passport_id in ( select passport_id from passport_master_entries where status='Cancel' )  order by passport_id desc");
