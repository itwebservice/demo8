      		    ...
      		    <div class="profile_box main_block" style="margin-top: 25px">
	                ...
	                <div class="table-responsive">
	                    ...
	                    <thead>
	                       ...
	                       <?php 
	                       $offset = "_u";
	                       $sq_entry_count = mysqli_num_rows(mysqlQuery("select * from passport_master_entries where passport_id='$passport_id'"));
	                       if($sq_entry_count==0){
	                       		include_once('passport_member_tbl.php');	
	                       }
	                       else{
	                       		$count = 0;
	                       		$sq_entry = mysqlQuery("select * from passport_master_entries where passport_id='$passport_id'");
                                $bg="";
