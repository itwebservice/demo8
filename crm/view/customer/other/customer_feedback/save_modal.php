        ...
        <div class="modal-body">
          <div class="row ">
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-xs-12">
                    <h3 class="editor_title">4. Quality of Accommodation Services</h3>
                    <div class="panel panel-default panel-body app_panel_style">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-12 mg_tp_10">
                          <h5>b) How would you rate your accommodations for Hygiene & Cleanliness?</h5>
                             <div class="col-md-12">
                      ...
                      <div class="col-md-12 mg_tp_10">
                         <h5>c) How was the quality & quantity of meal?</h5>
                         <div class="col-md-12">
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-xs-12">
                    <h3 class="editor_title">6. Please answer the following few questions based on your experience with us:</h3>
                    <div class="panel panel-default panel-body app_panel_style">
                      <div class="col-md-12">
