...
<div class="row">
	...
	<?php endif; ?>
	<div class="col-sm-4 mg_bt_10_sm_xs">
		<input type="text" id="from_date_filter" name="from_date_filter" placeholder="From Date" onchange="get_to_date(this.id,'to_date_filter');tasks_list_reflect()" title="From Date">
	</div>
	<div class="col-sm-4">
		<input type="text" id="to_date_filter" name="to_date_filter" placeholder="To Date" onchange="validate_validDate('from_date_filter','to_date_filter');tasks_list_reflect()" title="To Date">
	</div>
</div>
</div>
