	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12">
			<select name="booking_id" id="booking_id" style="width:100%" title="Select Booking" onchange="content_reflect()">
		        ...
		        <?php 
		        $sq_hotel = mysqlQuery("select * from hotel_booking_master where booking_id in ( select booking_id from hotel_booking_entries where status='Cancel' )  order by booking_id desc");
