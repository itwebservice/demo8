		...
		<form id="frm_refund" class="mg_bt_150">
			...
			<div class="row text-center">
				...
				<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
					<input type="text" name="total_refund_amount" id="total_refund_amount" class="amount_feild_highlight text-right" placeholder="Total Refund" title="Total Refund" value="<?= $refund_amount ?>" readonly >
				</div>
			</div>
