<div class="panel panel-default panel-body fieldset profile_background">
	<div class="tab-content">
	     	...
	     	<div class="row">
				<div class="col-md-12">
					<div class="profile_box main_block">
						<?php $sq_city = mysqli_fetch_assoc(mysqlQuery("select city_name from city_master where city_id='$sq_query[city_id]'")); ?>
						<div class="row">
							<div class="col-md-6" style="border-right: 1px solid #ddd">
								...
								<?php $sq_hotel = mysqli_fetch_assoc(mysqlQuery("select * from hotel_master where hotel_id='$sq_query[hotel_id]'")); ?>
								<span class="main_block">
									<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
									<?php echo "<label>Hotel Name <em>:</em></label> " .$sq_hotel['hotel_name']; ?>
								</span>
								<?php $sq_currency = mysqli_fetch_assoc(mysqlQuery("select * from currency_name_master where id='$sq_query[currency_id]'")); ?>
								<span class="main_block">
									<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
							...
							<div class="col-md-6 right_border_none_sm">
								...
								<span class="main_block">
									<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
									<?php echo "<label>Created At <em>:</em></label> ".get_dateTime_user($sq_query['created_at']); ?>
								</span>
							</div>
						</div>
			    </div>
	    ...
	    <!-- ********Tab1 End******** --> 
		<?php
		$sq_query = mysqlQuery("select * from hotel_contracted_tarrif where pricing_id='$pricing_id'");
		?>
				<div role="tabpanel" class="tab-pane active" id="basic_information">
					<div class="row">
						<div class="col-md-12">
