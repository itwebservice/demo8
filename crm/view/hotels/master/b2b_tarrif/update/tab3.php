<?php
$sq_tab4 = mysqlQuery("select * from hotel_weekend_tarrif where pricing_id='$pricing_id'");
$sq_count4 = mysqli_num_rows(mysqlQuery("select * from hotel_weekend_tarrif where pricing_id='$pricing_id'"));
?>
<form id="frm_tab4">
...
<div class="app_panel"> 
    ...
    <?php if($sq_count4 == 0){ ?>
		...
		<div class="col-md-12">
			...
			<?php
				$count = 1;
				while($row_tab4 = mysqli_fetch_assoc($sq_tab4)){ ?>
					<tr>
