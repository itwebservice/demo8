<?php
$sq_tab5 = mysqlQuery("select * from hotel_offers_tarrif where hotel_id='$hotel_id'");
$sq_count5 = mysqli_num_rows(mysqlQuery("select * from hotel_offers_tarrif where hotel_id='$hotel_id'"));
?>
<form id="frm_tab5">
    ...
    <!--=======Header panel end======-->
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td><select name="offer_type" data-toggle="tooltip" title="Offer Type" id="offer_type" style="width: 150px" class="form-control app_select2">
                        ...
                        <td><input type="text" id="to_date_h1" class="form-control" name="to_date_h1" placeholder="Valid To " title="Valid To" onchange="validate_validDate('from_date_h1' ,'to_date_h1')" value="<?= date('d-m-Y') ?>" style="width: 130px;" /></td>
		...
		<div class="col-md-12">
			...
			<?php
				...
				while($row_tab5 = mysqli_fetch_assoc($sq_tab5)){ ?>
                    <tr>
                        ...
                        <td><input type="text" id="to_date_h<?= $count ?>-u" class="form-control" name="to_date_h" placeholder="Valid To " title="Valid To" onchange="validate_validDate('from_date_h<?= $count ?>-u' ,'to_date_h<?= $count ?>-u')"  value='<?= get_date_user($row_tab5['to_date']) ?>' style="width: 130px;" /></td>
                        <td><select name="amount_in" id="amount_in" style="width: 150px" class="form-control app_select2"data-toggle="tooltip" title="Amount In">
                        ...
                        <td><select name="agent_type<?= $count ?>-u" id="agent_type<?= $count ?>-u" style="width: 150px" class="form-control app_select2" multiple>
                            <?php 
            ...
            <div class="row text-center mg_tp_20 mg_bt_150">
                <div class="col-xs-12">
                    <button class="btn btn-info btn-sm ico_left" type="button" onclick="switch_to_tab4()" data-toggle="tooltip" title="Previous"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp Previous</button>
                    &nbsp;&nbsp;
                    <button class="btn btn-sm btn-success" data-toggle="tooltip" title="Update" id="btn_price_update"><i class="fa fa-pencil"></i>&nbsp;&nbsp;Update</button>
                </div>
            </div>
</form>
<?= end_panel() ?>
