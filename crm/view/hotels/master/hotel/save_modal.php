...
$(function(){
  $('#frm_hotel_save').validate({
    ...
    submitHandler:function(form){
      ...
      if(((parseInt(cwob_from) == 0 || cwob_from == '')&&(parseInt(cwob_to) == 0 || cwob_to == ''))&&((parseInt(cwb_from) == 0 || cwb_from == '')&&(parseInt(cwb_to) == 0 || cwb_to == ''))){
        error_msg_alert('Enter Child With Bed & Child Without Bed Age in Hotel Amenities & Policies'); $('#accordion').css({ border: '1px solid red' }); return false;
      } // For missing Age Without Bed And With Bed (Full Blank)
      if(((parseInt(cwob_from) == 0 || cwob_from == '')&&(parseInt(cwob_to) == 0 || cwob_to == ''))&&((parseInt(cwb_from) != 0 || cwb_from != '')&&(parseInt(cwb_to) != 0 || cwb_to != ''))){
        error_msg_alert('Enter Child Without Bed From Age & To Age in Hotel Amenities & Policies'); $('#accordion').css({ border: '1px solid red' }); return false;
      } // For Missing Age -> Without Bed(To Blank,From Blank)
      if(((parseInt(cwob_from) != 0 || cwob_from != '')&&(parseInt(cwob_to) != 0 || cwob_to != ''))&&((parseInt(cwb_from) == 0 || cwb_from == '')&&(parseInt(cwb_to) == 0 || cwb_to == ''))){
        error_msg_alert('Enter Child With Bed From Age & To Age in Hotel Amenities & Policies'); $('#accordion').css({ border: '1px solid red' }); return false;
      } // For Missing Age -> With Bed(To Blank,From Blank)
      if(((parseInt(cwob_from) == 0 || cwob_from == '')&&(parseInt(cwob_to) != 0 || cwob_to != ''))&&((parseInt(cwb_from) == 0 || cwb_from == '')&&(parseInt(cwb_to) != 0 || cwb_to != ''))){
        error_msg_alert('Enter Child Without Bed From Age & With Bed From Age in Hotel Amenities & Policies'); $('#accordion').css({ border: '1px solid red' }); return false;
      } // For Missing Age -> Without Bed(From Blank) With Bed(From Blank)
      if(((parseInt(cwob_from) != 0 || cwob_from != '')&&(parseInt(cwob_to) == 0 || cwob_to == ''))&&((parseInt(cwb_from) != 0 || cwb_from != '')&&(parseInt(cwb_to) == 0 || cwb_to == ''))){
        error_msg_alert('Enter Child Without Bed To Age & With Bed To Age in Hotel Amenities & Policies'); $('#accordion').css({ border: '1px solid red' }); return false;
      } // For Missing Age -> Without Bed(To Blank) With Bed(To Blank)  
      if(((parseInt(cwob_from) != 0 || cwob_from != '')&&(parseInt(cwob_to) == 0 || cwob_to == ''))&&((parseInt(cwb_from) == 0 || cwb_from == '')&&(parseInt(cwb_to) != 0 || cwb_to != ''))){
        error_msg_alert('Enter Child Without Bed To Age & With Bed From Age in Hotel Amenities & Policies'); $('#accordion').css({ border: '1px solid red' }); return false;
      } // For Missing Age -> Without Bed(To Blank) With Bed(From Blank)  
      if(((parseInt(cwob_from) == 0 || cwob_from == '')&&(parseInt(cwob_to) != 0 || cwob_to != ''))&&((parseInt(cwb_from) != 0 || cwb_from != '')&&(parseInt(cwb_to) == 0 || cwb_to == ''))){
        error_msg_alert('Enter Child Without Bed From Age & With Bed To Age in Hotel Amenities & Policies'); $('#accordion').css({ border: '1px solid red' }); return false;
