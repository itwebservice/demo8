		 ...
		 <div class="profile_box main_block" style="min-height: 141px;">
	        ...
	        <div class="row">
	            <div class="col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
	        	    ...
	        	    <span class="main_block">
	        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	        	      <?php echo "<label>Roundoff <em>:</em></label> ".$sq_hotel_info['roundoff']; ?>
	        	    </span>
				 </div>
				 <div class="col-sm-6 col-xs-12">
	        	    ...
	        	    <span class="main_block">
	        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	        	      <?php echo "<label>TCS"."(".$sq_hotel_info['tcs_per']."%)"." <em>:</em></label> ".$sq_hotel_info['tcs_tax']; ?> 
	        	    </span>
	        		<span class="main_block">
	                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					...
					<span class="main_block">
		        		  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        		  <?php
							$sq_credit = mysqli_fetch_assoc(mysqlQuery("SELECT sum(`credit_charges`) as sumc FROM `hotel_booking_payment` WHERE `booking_id`='$sq_hotel_info[booking_id]' and `clearance_status`!='Cancelled' and clearance_status != 'Pending'"));
