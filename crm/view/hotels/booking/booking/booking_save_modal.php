        ...
        <form id="frm_hotel_booking_save">
          ...
          <div class="panel panel-default panel-body app_panel_style feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-sm-3 col-xs-12 mg_bt_10">
                <input type="text" id="childrens" name="childrens" placeholder="Children" title="Children" onchange="validate_balance(this.id);get_auto_values('booking_date','sub_total','payment_mode','service_charge','markup','save','true','service_charge','discount',true)">
              </div>
              <div class="col-sm-3 col-xs-12 mg_bt_10">
          ...
          <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 ">
                ...
                <input type="text" id="service_charge" name="service_charge" placeholder="Service Charge" title="Service Charge" onchange="total_fun();validate_balance(this.id);get_auto_values('booking_date','sub_total','payment_mode','service_charge','markup','save','true','service_charge','discount')">
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 ">
                <small>&nbsp;</small>
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <input type="text" id="markup" name="markup" placeholder="Markup Cost" title="Markup Cost" onchange="total_fun();get_auto_values('booking_date','sub_total','payment_mode','service_charge','markup','save','true','markup','discount');validate_balance(this.id)">
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <small>&nbsp;</small>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <input type="number" name="tcs_tax" id="tcs_tax" placeholder="TCS" title="TCS" onchange="total_fun();" <?= $tcs_readonly ?> />
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
...
<script>
  ...
  get_quotation_details('quotation_id');
                ...
                if (data !== 'valid') {
                  ...
                  $.ajax({
                    ...
                    data: {
                      ...
                      currency_code:currency_code,tcs_tax:tcs_tax,tcs_per:tcs_per
                    },
                    success: function(result) {
                      ...
                      if (msg[0] == 'error') {
                        ...
                        msg_popup_reload(msg1[0]);
                        window.open(base_url+'view/vendor/dashboard/estimate/estimate_save_modal.php?type=Hotel Booking&amount='+sub_total+'&booking_id='+msg1[1]);
                        setTimeout(() => {
  ...
  function whatsapp_send(emp_id, customer_id, booking_date, base_url,contact_no,email_id) {
    $.post(base_url + 'controller/hotel/booking/whatsapp_send.php', {
      emp_id: emp_id,
      customer_id: customer_id,
      booking_date: booking_date,contact_no:contact_no,email_id:email_id
    }, function(data) {
      console.log(data)
      window.open(data);
    });
