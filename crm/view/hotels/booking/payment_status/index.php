...
<div class="app_panel_content Filter-panel">
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			<select name="hbooking_id_filter" id="hbooking_id_filter" style="width:100%" title="Booking ID">
...
$('#customer_id_filter, #hbooking_id_filter, #cust_type_filter,#booker_id_filter,#branch_id_filter').select2();
...
var column = [
	...
	{ title : "TCS", className:"info text-right"},
...
function booking_list_reflect()
{
	...
	var booking_id = $('#hbooking_id_filter').val();
