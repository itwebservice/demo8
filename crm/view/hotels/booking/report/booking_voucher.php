...
if($role=="Booker")
{
  ...
  $booker_name = mysqli_fetch_assoc(mysqlQuery("select first_name, last_name from emp_master where emp_id='$booker_id'"));
...
$sq_service_voucher = mysqli_fetch_assoc( mysqlQuery("select * from hotel_booking_entries where entry_id='$voucher_id'") );
