...
$sq_query = mysqlQuery("select * from b2b_transfer_tariff_entries where tariff_id='$tariff_id'");
?>
<div class="modal fade profile_box_modal" id="hotel_view_modal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="myModalLabel">
