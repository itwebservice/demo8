...
if($tour_id!= ''){
	...
	while($row = mysqli_fetch_assoc($sq))
	{
		...
		<tr <?php if($status=="disabled"){ ?> class="danger" <?php }?>>
			...
			<td><input class="css-checkbox" type="checkbox" name="chk_tour_group" id="chk_tour_group<?php echo $count ?>" value="<?php echo $row['group_id'] ?>" <?php echo $status." ".$check ?>>   <label for="chk_tour_group<?php echo $count ?>" class="css-label"></label> </td>
		</tr>  
		<?php
	}
	?>
