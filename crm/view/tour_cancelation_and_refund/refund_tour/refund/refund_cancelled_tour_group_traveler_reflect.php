...
$tourwise_details1 = mysqli_fetch_assoc(mysqlQuery("select * from tourwise_traveler_details where id='$tourwise_id' "));
       ...
       <div class="table-responsive">
        ...
        <tfoot>
            <tr class="active">
                ...
                <th colspan="2" class="success" colspan="2">Total_Refund: <?= number_format(($paid_amt - $pending_amt - $cancel_amt),2) ?></th>
            </tr>
        </tfoot>
    </table>
    </div>
