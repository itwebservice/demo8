...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('U'.$row_count, "Due Date")
        ->setCellValue('V'.$row_count, "Purchase")
        ->setCellValue('W'.$row_count, "Purchased From")
        ->setCellValue('X'.$row_count, "Branch")
        ->setCellValue('Y'.$row_count, "Booked By")
...
$objPHPExcel->getActiveSheet()->getStyle('B'.$row_count.':Z'.$row_count)->applyFromArray($borderArray);    
        ...
        while($row_package = mysqli_fetch_assoc($sq_package)){
            ...
            ->setCellValue('P'.$row_count, number_format($tour_fee,2))
            ->setCellValue('Q'.$row_count, number_format($tour_esti,2))
            ->setCellValue('R'.$row_count, number_format($total_amount,2))
            ->setCellValue('S'.$row_count, number_format($total_paid,2))
            ->setCellValue('T'.$row_count, number_format($total_balance,2))
            ->setCellValue('U'.$row_count, get_date_user($row_package['due_date']))
