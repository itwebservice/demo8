...
<?php 
  ...
  {
      $sq_customer = mysqli_fetch_assoc(mysqlQuery("select first_name, last_name,type,company_name from customer_master where customer_id='$row_booking[customer_id]'"));
