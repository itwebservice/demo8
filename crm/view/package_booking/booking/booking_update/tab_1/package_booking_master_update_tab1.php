            ...
            <div class="app_panel_content Filter-panel">
                <div class="row ">
                       ...
                       if($sq_booking_info['quotation_id'] != 0){
                        ...
                        $quotation_cost = $basic_cost +$service_charge+ $service_tax_amount+ $sq_quo['train_cost'] + $sq_cost['cruise_cost']+ $sq_quo['flight_cost'] + $sq_quo['visa_cost'] + $sq_quo['guide_cost'] + $sq_quo['misc_cost'];
                       ?>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10_sm_xs">
                        <input type="text" id="package_type" name="package_type" placeholder="Package Type" title="Package Type" value="<?php echo $sq_booking_info['package_type'] ?>" readonly>
                    </div>
                    <?php } ?>
...
<h5 class="booking-section-heading main_block">Customer Details</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                <select id="txt_m_state1" name="txt_m_state" title="State" style="width:100%" disabled>
                    <?php 
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                <select name="country_name" id="country_name1" title="Country Name" style="width:100%" disabled>
                    <?php 
...
<h5 class="booking-section-heading main_block">Passenger Details</h5>
    ...
    ?>    
        <tr class="<?= $bg?>">
            ...
            <td><select id="cmb_m_honorific1" name="cmb_m_honorific1" onchange="changeGender(this.id)" title="Honorific" <?= $disabled;?>>
            ...
            <td style="width: 129px;"><input type="text"  style="width: 129px;"id="<?php echo 'txt_m_first_name'.$count_m.'m' ?>" name="<?php echo 'txt_m_first_name'.$count_m.'m' ?>" <?= $disabled;?> onchange="fname_validate(this.id);" placeholder="First Name" title="First Name" value="<?php echo $row_traveler_grop_details['first_name'] ?>"  /></td>                 
            <td><input type="text" style="width: 129px;" id="<?php echo 'txt_m_middle_name'.$count_m.'m' ?>" name="<?php echo 'txt_m_middle_name'.$count_m.'m' ?>" <?= $disabled;?>  placeholder="Middle Name" onchange="fname_validate(this.id);" title="Middle Name" value="<?php echo $row_traveler_grop_details['middle_name'] ?>" /></td>
            <td style="width: 129px;"><input type="text" style="width: 129px;" id="<?php echo 'txt_m_last_name'.$count_m.'m' ?>" name="<?php echo 'txt_m_last_name'.$count_m.'m' ?>" onchange="fname_validate(this.id);" <?= $disabled;?>  placeholder="Last Name" title="Last Name" value="<?php echo $row_traveler_grop_details['last_name'] ?>" /></td>
            ...
            <td><input type="text" maxlength="20" style="width: 129px;" id="<?php echo 'm_birthdate'.$count_m.'m' ?>" name="<?php echo 'm_birthdate'.$count_m.'m' ?>"  <?= $disabled;?> value="<?php if($row_traveler_grop_details['birth_date']!="") { echo date("d-m-Y", strtotime($row_traveler_grop_details['birth_date'])); } ?>" onchange="calculate_age_member(this.id);" placeholder="Birth Date" title="Birth Date"/></td>
            ...
            <td style="width: 139px;"><input type="text" style="width: 129px;" id="txt_m_passport_no<?= $count_m ?>m" name="txt_m_passport_no1"  <?= $disabled;?> placeholder="Passport No" onchange=" validate_specialChar(this.id)" title="Passport No" value="<?= $row_traveler_grop_details['passport_no'] ?>" style="text-transform: uppercase;" <?= $tourtype_display ?> ></td>
            <td style="width: 130px;"><input type="text" style="width: 129px;" id="txt_m_passport_issue_date<?= $count_m ?>m" name="txt_m_passport_issue_date1"  <?= $disabled;?> placeholder="Issue Date" onchange="validate_validDate('txt_m_passport_issue_date<?= $count_m ?>m','txt_m_passport_expiry_date<?= $count_m ?>m')" title="Passport Issue Date" value="<?= get_date_user($row_traveler_grop_details['passport_issue_date']) ?>" <?= $tourtype_display ?>></td>
            <td style="width: 132px;"><input type="text" style="width: 129px;" id="txt_m_passport_expiry_date<?= $count_m ?>m" name="txt_m_passport_expiry_date1" <?= $disabled;?> placeholder="Expire Date"  onchange="validate_issueDate('txt_m_passport_issue_date<?= $count_m ?>m','txt_m_passport_expiry_date<?= $count_m ?>m')" title="Expire Date" value="<?= get_date_user($row_traveler_grop_details['passport_expiry_date']) ?>" <?= $tourtype_display ?>></td>
