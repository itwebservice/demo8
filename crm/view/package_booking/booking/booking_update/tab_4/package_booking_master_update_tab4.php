                    ...
                    <div class="bg_white main_block panel-default-inner">
                        <div class="main_block text-center">
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                ...
                                <input type="text" id="txt_hotel_expenses" name="txt_hotel_expenses" placeholder="Tour Amount" title="Tour Amount" value="<?php echo $sq_booking_info['total_hotel_expense']; ?>" onchange="validate_balance(this.id);calculate_tour_cost(this.id);get_auto_values('booking_date','total_basic_amt','payment_mode','service_charge','markup','update','true','basic','basic',true);">
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
                                <label for="txt_travel_total_expense1">Travel Amount</label>
                                <input type="text" id="txt_travel_total_expense1" class="text-right" name="txt_travel_total_expense1" placeholder="Travel Amount" title="Travel Amount" onchange="validate_balance(this.id);calculate_tour_cost(this.id)" value="<?php echo $sq_booking_info['total_travel_expense']; ?>" readonly>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <small>&nbsp;</small>
                                ...
                                <input type="text" id="subtotal" name="subtotal" placeholder="Subtotal" title="Subtotal" value="<?= $sq_booking_info['subtotal'] ?>" onchange="validate_balance(this.id); calculate_total_tour_cost()" readonly>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
                            <small>&nbsp;</small>
                                <label for="tour_service_tax_subtotal">Tax Subtotal</label>
                                <input class="form-control" type="text" id="tour_service_tax_subtotal" title="Tax Subtotal" name="tour_service_tax_subtotal" value="<?php echo $sq_booking_info['tour_service_tax_subtotal']; ?>" readonly>  
                            </div>
                            
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            <label for="tcs">TCS</label>
                                <input type="number" name="tcs_tax" id="tcs_tax" class="text-right" placeholder="TCS" title="TCS" onchange=" calculate_total_tour_cost()" value="<?= $sq_booking_info['tcs_tax'] ?>" <?= $tcs_readonly ?>>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
                                ...
                                <input type="text" id="txt_actual_tour_cost1" class="amount_feild_highlight text-right" name="txt_actual_tour_cost1" placeholder="Total Amount" title="Total Amount" value="<?= $sq_booking_info['net_total'] ?>" readonly>
                            </div>
