	...
	<div class="col-md-4 col-sm-12 col-xs-12 mg_bt_20_xs">
		<div class="profile_box main_block" style="min-height: 141px;">
			...
			<span class="main_block">
				...
				<?php echo $sq_package_info['total_train_expense']; ?> 
			</span>
		</div>	
	</div>	
	<div class="col-md-4 col-sm-12 col-xs-12 mg_bt_20_xs">
		<div class="profile_box main_block" style="min-height: 141px;">
			...
			<span class="main_block">
				<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
				<?php echo $sq_package_info['total_plane_expense']; ?> 
			</span>
		</div>	
	</div>
	<div class="col-md-4 col-sm-12 col-xs-12 mg_bt_20_xs">
		<div class="profile_box main_block" style="min-height: 141px;">
	        <h3>Cruise Amount</h3>
				<span class="main_block">
					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					<?php echo $sq_package_info['total_cruise_expense']; ?> 
				</span>
		</div>	
	</div>
</div>
...
<div class="row mg_bt_20">
	<div class="col-md-4 col-sm-12 col-xs-12 mg_bt_20_xs">
		<div class="profile_box main_block" style="min-height: 141px;">
			...
			<span class="main_block">
				<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
				<?php echo $sq_package_info['total_hotel_expense']; ?> 
			</span>
		</div>	
	</div>	
	<div class="col-md-4 col-sm-12 col-xs-12 mg_bt_20_xs">
		<div class="profile_box main_block" style="min-height: 141px;">
			...
			<span class="main_block">
				<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
				<?php echo $sq_package_info['total_travel_expense']; ?> 
			</span>
		</div>	
	</div>
</div>
		...
		<div class="profile_box main_block" style="min-height: 141px;">
			...
			<div class="row">
				<div class="col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
					...
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
						<?php echo "<label>Subtotal  <em>:</em></label> ".number_format($sq_package_info['basic_amount']+$sq_package_info['service_charge'],2); ?>
					</span>
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
				...
				<div class="col-sm-6 col-xs-12 right_border_none_sm_xs">
					...
					<span class="main_block">
						<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
						<?php echo '<label>TCS'.'('.$sq_package_info['tcs_per'].'%)'.'<em>:</em></label> '.$sq_package_info['tcs_tax']; ?>
					</span>
					<?php
