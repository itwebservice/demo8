        ...
        <div class="table-responsive">
            <table id="tbl_package_transport_infomration" class="table table-bordered table-hover table-striped" style="width: 100%;">
                <tr>
                    ...
                    <td><input type="text" id="txt_tsp_from_date" name="txt_tsp_from_date" placeholder="*Start Date" title="Start Date" style="width:170px;" onchange="get_to_date(this.id,'txt_tsp_end_date')"></td>
                    <td><input type="text" id="txt_tsp_end_date" name="txt_tsp_end_date" placeholder="*End Date" title="End Date" style="width:170px;" onchange="validate_validDate('txt_tsp_from_date','txt_tsp_end_date')"></td>
