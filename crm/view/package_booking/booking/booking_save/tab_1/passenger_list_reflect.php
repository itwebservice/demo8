<div class="row"> 
    ...
    <div class="col-md-12"> <div class="table-responsive">
        <table id="tbl_package_tour_member" class="table table-bordered table-hover table-striped" style="width:1504px">
            <tr>
                <td><input id="check-btn-member-1" type="checkbox" checked onchange="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','service_charge')"></td>
                ...
                <td style="width: 129px;"><input type="text" maxlength="20" id="m_birthdate1" name="m_birthdate1" onchange="calculate_age_member(this.id); " value="<?php echo date('d-m-Y') ?>" placeholder="Birth Date" title="Birth date" /></td>
