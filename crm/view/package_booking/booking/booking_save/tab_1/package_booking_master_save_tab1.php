        ...
        <div class="container">
            ...
            <div class="app_panel_content Filter-panel">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
                        <select name="quotation_id" id="quotation_id" title="Select Quotation" style="width:100%;" onchange="quotation_info_load()">
                            ...
                            while($row_quotation = mysqli_fetch_assoc($sq_quotation)){
                                ...
                                ?>
                                <option value="<?= $row_quotation['quotation_id'] ?>"><?= 'PTQ-'.$row_quotation['quotation_id'].' : '.$row_quotation['customer_name'].' : '.$quotation_cost.' /-'.$currency_amount ?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                        <select name="tour_type" id="tour_type" title="Tour Type" onchange="passport_fields_toggle(this.value);calculate_total_tour_cost();">
    ...
    <div class="row"> <div class="col-xs-12"> <div class="table-responsive">
        <table id="tbl_package_tour_member" class="table table-bordered table-hover table-striped" style="width:1504px">
            <tr>
                ...
                <td><select id="cmb_m_honorific1" name="cmb_m_honorific1" title="Honorific" onchange="changeGender(this.id);">
                ...
                <td style="width: 129px;"><input type="text" style="width: 129px;" id="txt_m_first_name1" name="txt_m_first_name1" onchange="fname_validate(this.id);" placeholder="*First Name" title="First Name" /></td>                        
                <td><input type="text" style="width: 129px;" onchange="fname_validate(this.id);"  id="txt_m_middle_name1" name="txt_m_middle_name1"  placeholder="Middle Name" title="Middle Name" /></td>
                <td style="width: 129px;"><input type="text" style="width: 129px;" id="txt_m_last_name1"  onchange="fname_validate(this.id);"  name="txt_m_last_name1"  placeholder="Last Name" title="Last Name"/></td>
                <td><select id="cmb_m_gender1" name="cmb_m_gender1"  title="Select gender"> 
                        <option value="Male"> M </option>
                        <option value="Female"> F </option>
                    </select>
                </td>
                <td><input type="text" maxlength="20" style="width: 129px;" id="m_birthdate1" name="m_birthdate1" onchange="calculate_age_member(this.id); adolescence_reflect(this.id);" value="<?= date('d-m-Y',  strtotime(' -1 day'))?>" placeholder="Birth Date" title="Birth date" /></td>
                ...
                <td style="width: 139px;"><input type="text" style="width: 129px;" id="txt_m_passport_no1" onchange="validate_specialChar(this.id);" name="txt_m_passport_no1"  placeholder="Passport No" title="Passport No" disabled></td>
                <td style="width: 130px;"><input type="text" style="width: 129px;" id="txt_m_passport_issue_date1" onchange="validate_futuredate('txt_m_passport_issue_date1')" name="txt_m_passport_issue_date1" placeholder="Issue Date" title="Passport Issue Date" disabled></td>
                <td style="width: 132px;"><input type="text" style="width: 129px;" id="txt_m_passport_expiry_date1" onchange="validate_pastDate(this.id)" name="txt_m_passport_expiry_date1"  placeholder="Expiry Date" title="Passport Expiry Date" disabled></td>
            </tr>
        </table> 
    </div></div></div>
</div>
...
function cust_csv_save(){
    ...
    $.ajax({
        ...
        data:{cust_csv_dir : cust_csv_dir , tour_type : tour_type},
