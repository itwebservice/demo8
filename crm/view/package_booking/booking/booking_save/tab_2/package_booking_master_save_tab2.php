...
<!--=======Header panel======-->
    <div class="app_panel_head mg_bt_20">
        <div class="container">
            ...
            <button onclick="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','service_charge')">
                <a>
            ...
            <div class="panel panel-default panel-body bg_light mg_bt_20">
                <div class="row text-center">
                    ...
                    <div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-12">
                        <input type="text" id="txt_travel_total_expense" class="amount_feild_highlight text-right" name="txt_travel_total_expense" title="Total Travel Expense" value="0" readonly />
                    </div>
                </div>
            </div>
        </div>
...
$('#txt_arravl1,#txt_depart1').datetimepicker({ format:'d-m-Y H:i' });
</script>
