                    ...
                    <div class="bg_white main_block panel-default-inner">
                        <div class="main_block text-center">
                            ...
                            <small>&nbsp;</small>
                                ...
                                <input type="text" id="txt_travel_total_expense1" name="txt_travel_total_expense1" onchange="validate_balance(this.id);calculate_tour_cost(this.id)" placeholder="Travel Cost" title="Travel Cost" value="0" readonly/>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                <small id="basic_show" style="color:#000000">&nbsp;</small>
                                <label for="total_basic_amt">Basic Amount</label>
                                <input type="text" id="total_basic_amt" class="text-right" name="total_basic_amt" onchange="calculate_tour_cost(this.id);get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','basic');validate_balance(this.id);" placeholder="Total Basic Cost" title="Total Basic Cost" value="0" readonly/>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
                                ...
                                <input type="text" title="Tax Subtotal" id="tour_service_tax_subtotal" name="tour_service_tax_subtotal" value="0" readonly>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            <label for="tcs">TCS</label>
                                <input type="number" name="tcs_tax" id="tcs_tax" class="text-right" placeholder="TCS" title="TCS" onchange="calculate_total_tour_cost()" <?= $tcs_readonly ?>>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                ...
                                <input type="text" id="txt_actual_tour_cost1" class="amount_feild_highlight text-right" name="txt_actual_tour_cost1" placeholder="Total Amount" title="Total Amount" readonly>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs hidden">
                                <label for="currency_code">Currency</label>
                                <select name="currency_code3" id="currency_code3" style="width:100%" title="Currency">
                                    <?php 
