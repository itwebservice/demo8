...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('P'.$row_count, "Total Amount")
        ->setCellValue('Q'.$row_count, "Cancel Amount")
...
$sq_booking = mysqlQuery($query);
  while($row_booking = mysqli_fetch_assoc($sq_booking)){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
      ...
      ->setCellValue('O'.$row_count, $row_booking['tcs_tax'])
      ->setCellValue('P'.$row_count, number_format($total_booking_amt, 2))
...
->setCellValue('Q'.$row_count, number_format($total_cancel,2))
->setCellValue('R'.$row_count, number_format($total_paid,2))
