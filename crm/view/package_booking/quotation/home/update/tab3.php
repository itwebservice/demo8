						...
						<div class="row">
							    ...
							    <div class="col-xs-12">
							        ...
							        <tr>
										...
										<td><input type="text" id="transport_start_date-" name="transport_start_date-" placeholder="Start Date" title="Start Date" class="app_datepicker" style="width:150px" onchange="get_to_date(this.id,'transport_end_date-');get_transport_cost_update(this.id);"></td>
										...
										<td class="hidden"><input type="text" id="transport_cost-" name="transport_cost-" placeholder="Cost" title="Cost" style="width:150" style="display:none;"></td> 
										<td class="hidden"><input type="text" id="package_name-" name="package_name-" placeholder="Package Name" title="Package Name" style="width:200px" style="display:none;" readonly></td> 
									...
									<script type="text/javascript">
										...
										$('#transport_start_date-,#transport_end_date-').datetimepicker({ format:'d-m-Y',timepicker:false });	
									</script>
									<?php
									}
									else{
										    ...
										    <td><input type="text" id="transport_start_date-<?= $count ?>_u" name="transport_start_date-<?= $count ?>_u" style="width:150px" placeholder="Start Date" title="Start Date" class="app_datepicker" onchange="get_to_date(this.id,'transport_end_date-<?= $count ?>_u');get_transport_cost_update(this.id);" value="<?= date('d-m-Y', strtotime($row_q_tr['start_date'])) ?>"></td>
											<td><input type="text" id="transport_end_date-<?= $count ?>_u" name="transport_end_date-<?= $count ?>_u" placeholder="End Date" title="End Date" class="app_datepicker" style="width:150px" onchange="validate_validDate('transport_start_date-<?= $count ?>_u','transport_end_date-<?= $count ?>_u');" value="<?= date('d-m-Y', strtotime($row_q_tr['end_date'])) ?>"></td>
											...
											<td class="hidden"><input type="text" id="transport_cost-<?= $count ?>_u" name="transport_cost-<?= $count ?>_u" placeholder="Cost" title="Cost" style="width:170px" value="<?=$row_q_tr['transport_cost']?>"></td> 
										...
										<script type="text/javascript">
											...
											$('#transport_start_date-<?= $count ?>_u,#transport_end_date-<?= $count ?>_u').datetimepicker({ format:'d-m-Y',timepicker:false });	
										</script>
							            <?php
				        				}
				        			}
					...
					<div class="panel panel-default main_block">
					    ...
					    <div id="collapse6" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading1">
					        <div class="panel-body">
					        	<div class="row">
								    <div class="col-xs-12 text-right mg_bt_20_sm_xs">
								        <button type="button" class="btn btn-excel btn-sm" onClick="addRow('tbl_package_tour_quotation_dynamic_excursion','2');city_lzloading('.act_city', '*City')"><i class="fa fa-plus"></i></button>
								    </div>
								</div>
								<div class="row">
								    <div class="col-xs-12">
								        ...
								        <?php 
								            ...
								            <tr>
    											...
    											<td><input type="text" class="form-control app_datetimepicker" id="exc_date-1" name="exc_date-1" placeholder="Activity Date/Time" title="Activity Date/Time" value="<?= date('d-m-Y H:i') ?>" style="width:130px" onchange="get_excursion_amount_update(this.id);"></td>
								                <td><select id="city_name-1" class="form-control app_select2 act_city" name="city_name-1" title="City Name" style="width:150px" onchange="get_excursion_list(this.id);">
													<option value="">*City</option>
													</select></td>
												<td><select id="excursion-1" class="form-control app_select2" title="Activity Name" name="excursion-1" style="width:150px" onchange="get_excursion_amount_update(this.id);">
									            ...
									            <td><input type="number" id="adult-1" name="adult-1" placeholder="Adult(s)" title="Adult(s)" style="width:150px" onchange="get_excursion_amount();validate_balance(this.id);validate_pax_count(this.id,'Adult');"></td>
									            ...
									            <td><input type="number" id="infant-1" name="infant-1" placeholder="Infant(s)" title="Infant(s)" style="width:150px" onchange="get_excursion_amount();validate_balance(this.id);validate_pax_count(this.id,'Infant');" ></td>
									            <td style="display:none"><input type="text" id="excursion_amount-1" name="excursion_amount-1" placeholder="Activity Amount" title="Activity Amount" style="width:150px;display:none;" onchange="validate_balance(this.id);" ></td>
								            ...
								            <?php
    											...
    											<td><input type="text" id="exc_date-<?= $count ?>_u" name="exc_date-<?= $count ?>_u" placeholder="Activity Date & Time" title="Activity Date & Time" class="app_datetimepicker" value="<?= get_datetime_user($row_q_ex['exc_date']) ?>" style="width:150px" onchange="get_excursion_amount_update(this.id);"></td>
								                <td><select id="city_name-<?= $count ?>_u" class="app_select2 form-control act_city" name="city_name-<?= $count ?>_u" title="City Name" style="width:150px" onchange="get_excursion_list(this.id);">
													<option value="<?php echo $sq_city['city_id'] ?>"><?php echo $sq_city['city_name'] ?></option>
													<option value="">*City</option>
										            </select>
								                </td>
								                <td><select id="excursion-<?= $count ?>_u" class="app_select2 form-control" title="Activity Name" name="excursion-<?= $count ?>_u" style="width:150px" onchange="get_excursion_amount_update(this.id);">
									                <option value="<?php echo $sq_ex['entry_id'] ?>"><?php echo $sq_ex['excursion_name'] ?></option>
									                <option value="">*Activity Name</option>
									            </select></td>
												<td><select name="transfer_option-<?= $count ?>_u" id="transfer_option-<?= $count ?>_u" data-toggle="tooltip" class="form-contrl app_select2" title="Transfer Option" style="width:150px" onchange="get_excursion_amount_update(this.id);">
									            ...
									            <td><input type="number" id="adult-1" name="adult-1" placeholder="Adult(s)" title="Adult(s)" style="width:150px" onchange="get_excursion_amount();validate_balance(this.id);validate_pax_count(this.id,'Adult');" value="<?= $row_q_ex['adult'] ?>"></td>
									            <td><input type="number" id="child-1" name="child-1" placeholder="Child With-Bed" title="Child With-Bed" style="width:150px" onchange="get_excursion_amount();validate_balance(this.id);validate_pax_count(this.id,'ChildWithBed');" value="<?= $row_q_ex['chwb'] ?>" ></td>
									            <td><input type="number" id="childwo-1" name="childwo-1" placeholder="Child Without-Bed" title="Child Without-Bed" style="width:150px" onchange="get_excursion_amount();validate_balance(this.id);validate_pax_count(this.id,'ChildWithoutBed');" value="<?= $row_q_ex['chwob'] ?>" ></td>
									            <td><input type="number" id="infant-1" name="infant-1" placeholder="Infant(s)" title="Infant(s)" style="width:150px" onchange="get_excursion_amount();validate_balance(this.id);validate_pax_count(this.id,'Infant');" value="<?= $row_q_ex['infant'] ?>" ></td>
												<td style="display:none"><input type="text" id="excursion_amount-<?= $count ?>_u" name="excursion_amount-<?= $count ?>_u"  onchange="validate_balance(this.id)" placeholder="Activity Amount" title="Activity Amount" style="width:150px" value="<?php echo $row_q_ex['excursion_amount'] ?>"></td>
									            <td style="display:none"><input type="number" id="adult_total-1" name="adult_total-1" style="width:100px;display:none;" ></td>
									            <td style="display:none"><input type="number" id="child_total-1" name="child_total-1" style="width:100px;display:none;" ></td>
									            <td style="display:none"><input type="number" id="childwo_total-1" name="childwo_total-1" style="width:100px;display:none;" ></td>
									            <td style="display:none"><input type="number" id="infant_total-1" name="infant_total-1" style="width:100px;display:none;" ></td>
	...
	for(var i=0; i<rowCount; i++){
		...
		if(row.cells[0].childNodes[0].checked){
			...
			if(transport_id==""){
				...
				$('.accordion_content').removeClass("indicator");
				$('#tbl_package_tour_quotation_dynamic_transport_u').parent('div').closest('.accordion_content').addClass("indicator");
				return false;
			}
			if(travel_date==""){
