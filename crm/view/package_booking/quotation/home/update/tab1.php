...
<!--=======Header panel end======-->
	...
	<div class="row mg_tp_10">	
	    ...
	    <div class="col-md-4 col-sm-6 col-xs-12">
	     ...
	     <input type="text" id="to_date12" name="to_date12" placeholder="To Date" title="To Date" onchange=" total_days_reflect('12');validate_validDate('from_date12' , 'to_date12');" value="<?= date('d-m-Y', strtotime($sq_quotation['to_date'])) ?>">
	...
	<div class="row mg_tp_10 mg_bt_20">	
