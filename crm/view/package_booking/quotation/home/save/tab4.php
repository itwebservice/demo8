							...
							<div class="table-responsive">
								<table id="tbl_package_tour_quotation_dynamic_costing" name="tbl_package_tour_quotation_dynamic_costing" class="table border_0 no-marg">
									<tr>
										...
										<td class="header_btn hidden" style="display:none;"><small>&nbsp;</small><input type="text" maxlength="15" value="1" name="username" placeholder="Sr. No." class="form-control" disabled /></td>
										...
										<td class="header_btn"><small>&nbsp;</small><input type="text" id="tour_cost-" name="tour_cost-" placeholder="Hotel Cost" title="Hotel Cost" value="0" onchange="quotation_cost_calculate(this.id);validate_balance(this.id)" style="width:100px"><span>Hotel Cost</span></td>
										<td class="header_btn"><small>&nbsp;</small><input type="text" id="transport_cost1-" name="transport_cost1-" placeholder="Transport Cost" title="Transport Cost" onchange="quotation_cost_calculate(this.id);validate_balance(this.id)" style="width:100px" value="0"><span>Transport Cost</span></td>    
										<?php
										$add_class1 = '';
										if($role == 'B2b'){
											$add_class1 = "hidden";
										...
										<td class="header_btn"><small>&nbsp;</small><input type="text" id="excursion_cost-" name="excursion_cost-" onchange="quotation_cost_calculate(this.id);validate_balance(this.id);"  placeholder="Activity Cost" title="Activity Cost" style="width:100px" value="0"><span>Activity Cost</span></td>

										<td class="header_btn"><small id="basic_show-" style="color:#000000">&nbsp;</small><input type="<?= $add_class1 ?>" id="basic_amount-" name="basic_amount-" onchange="get_business(this.id,'true',true);validate_balance(this.id);"  placeholder="Basic Amount" title="Basic Amount" style="width:100px" readonly><span>Basic Amount</span></td>
										
										<td class="header_btn"><small id="service_show-" style="color:#000000">&nbsp;</small><input type="<?= $add_class1 ?>" id="service_charge-" name="service_charge-" onchange="get_business(this.id,'false');quotation_cost_calculate(this.id); validate_balance(this.id)" value="0.00"  placeholder="Service charge" title="Service charge" style="width:100px"><span>Service charge</span></td>	

										<td class="header_btn"><small>&nbsp;</small><input type="text" id="service_tax_subtotal-" name="service_tax_subtotal-" readonly  placeholder="Tax Amount" title="Tax Amount" style="width:150px"><span>Tax Amount</span></td>
										...
										<td class="header_btn hidden" style="display:none;"><small>&nbsp;</small><input type="text" id="package_name1" name="package_name1" placeholder="Package Name" title="Package Name" style="width: 160px;display:none;" readonly></td> 

										<td class="header_btn hidden" style="display:none;"><small>&nbsp;</small><input type="text" id="package_id1" name="package_id1" placeholder="Package ID" title="Package ID" style="display:none;"></td>
									</tr>
								</table>
							</div>
						</div>
...
$('#frm_tab4').validate({
	...
	var rowCount = table.rows.length;
		...
		if(row.cells[0].childNodes[0].checked)
		{
			...
			console.log($(row.cells[7].childNodes[2]));
			bsmvaluesEach.push({
			"basic" : 'basic',
			"service" : 'service'
			});
