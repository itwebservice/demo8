...
<div class="app_panel">
	...
	<!--=======Header panel end======-->
		...
		<div class="row mg_tp_10">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<input type="text" id="from_date" name="from_date" placeholder="*From Date" title="From Date" onchange="validate_validDate('from_date','to_date');get_to_date(this.id,'to_date');total_days_reflect();" required>

			</div>

			<div class="col-md-4 col-sm-6 col-xs-12">

				<input type="text" id="to_date" name="to_date" placeholder="*To Date" title="To Date" onchange="validate_validDate('from_date','to_date');total_days_reflect()" required>
...
$('#frm_tab1').validate({
	...
	submitHandler:function(form){
		...
		if(infant == ''){ infant = 0; }else{ infant = parseInt(infant); }
		if(chwob == ''){ chwob = 0; }else{ chwob = parseInt(chwob); }
		if(chwb == ''){ chwb = 0; }else{ chwb = parseInt(chwb); }
