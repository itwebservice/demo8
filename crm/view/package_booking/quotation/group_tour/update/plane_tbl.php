        ...
        <table id="tbl_package_tour_quotation_dynamic_plane_update" name="tbl_package_tour_quotation_dynamic_plane_update" class="table table-bordered pd_bt_51">
			...
			if($sq_plane_count==0){
				...
				<tr>
		            ...
		            <td><select name="plane_class-1" id="plane_class-1" title="Class" style="width: 100%;">
				...
				while($row_q_plane = mysqli_fetch_assoc($sq_q_plane)){
					...
					<tr>
		                ...
		                <td><input type="text" name="from_sector-1" id="from_sector-<?= $offset.$count ?>_d" placeholder="From Sector" title="From Sector" style="width: 100%;" value="<?php echo ($sq_city['city_name']) ? $sq_city['city_name']." - ".$row_q_plane['from_location'] : ''; ?>">
						</td>
						<td><input type="text" name="to_sector-1" id="to_sector-<?= $offset.$count ?>_d" placeholder="To Sector" title="To Sector" style="width: 100%;" value="<?php echo ($sq_city2['city_name']) ? $sq_city2['city_name']." - ".$row_q_plane['to_location'] : ''; ?>">
						</td>	
		                 <td><select id="airline_name-<?= $offset.$count ?>_d" class="app_select2 form-control" name="airline_name-<?= $offset.$count ?>_d" style="width: 100% !important;">
			            ...
			            <td><input type="text" id="txt_dapart-<?= $offset.$count ?>_d" name="txt_dapart-<?= $offset.$count ?>_d" class="app_datetimepicker" placeholder="Departure Date and Time" title="Departure Date and Time" value="<?= date('d-m-Y H:i', strtotime($row_q_plane['dapart_time'])) ?>" onchange="get_to_datetime(this.id,'txt_arrval-<?= $offset.$count ?>_d')" style="width: 100%;" /></td>
			            <td><input type="text" id="txt_arrval-<?= $offset.$count ?>_d" name="txt_arrval-<?= $offset.$count ?>_d" class="app_datetimepicker" placeholder="Arrival Date and Time" title="Arrival Date and Time" value="<?= date('d-m-Y H:i', strtotime($row_q_plane['arraval_time'])) ?>" style="width: 100%;" onchange="validate_validDatetime('txt_dapart-<?= $offset.$count ?>_d',this.id)"/></td>
