...
<form id="frm_tab1">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	    	...
	    	<input type="text" id="tour_name" name="tour_name" onchange="validate_spaces(this.id);" placeholder="*Destination Name" title="Destination Name">
	    ...
	    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      ...
	      <input type="text" id="to_date" name="to_date" placeholder="*To Date" title="To Date" onchange="validate_validDate('from_date','to_date');total_days_reflect();change_dates_ever(this.id);">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	    	...
	    	<input type="text" id="customer_name" name="customer_name" onchange="fname_validate(this.id)" placeholder="*Customer Name" title="Customer Name" required>
	    ...
	    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	    	...
	    	<input type="text" id="total_adult" name="total_adult" placeholder="*Total Adult" title="Total Adult" onchange="total_passangers_calculate(); validate_balance(this.id)">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			...
			<input type="text" id="total_infant" name="total_infant" placeholder="Total Infant" title="Total Infant" onchange="total_passangers_calculate(); validate_balance(this.id)">
