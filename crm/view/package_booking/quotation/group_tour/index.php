            ...
            <div id="div_id_proof_content">
				...
				<div class="app_panel_content Filter-panel">
					<div class="row">
						...
						<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
							<select name="booking_type_filter" id="booking_type_filter" title="Tour Type" onchange="quotation_list_reflect()">
						...
						<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
							<select name="tour_name" id="tour_name_filter" title="Select Tour Name" style="width:100%" onchange="quotation_list_reflect()">
								...
								<?php
								$query = "select distinct(tour_name) from group_tour_quotation_master where 1 ";		
						...
						<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
							<select name="quotation_id" id="quotation_id" title="Select Quotation" onchange="quotation_list_reflect()" style="width:100%">
								...
								<?php 
								$query = "select * from group_tour_quotation_master where 1 and financial_year_id='$financial_year_id' ";				
								if($role == 'B2b' || $role=='Sales' || $role=='Backoffice'){
									$query .= " and emp_id='$emp_id'";
								}
								if($branch_status=='yes' && $role!='Admin'){
				...
				<div class="row mg_tp_20"> <div class="col-md-12 no-pad"> <div class="table-responsive">
        				<table id="group_table" class="table table-hover" style="width:100% !important;margin: 20px 0 !important;">         
        				</table>
    				</div></div></div>
				</div>
