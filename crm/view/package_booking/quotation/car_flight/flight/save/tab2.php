								    ...
								    <div class="col-xs-12">
								        ...
								        <table id="tbl_flight_quotation_dynamic_plane" name="tbl_flight_quotation_dynamic_plane" class="table table-bordered no-marg pd_bt_51">
								            ...
								            <tr>
									            ...
									            <td><input type="text" id="txt_dapart-1" name="txt_dapart-1" class="app_datetimepicker form-control" placeholder="*Departure Date & Time" title="Departure Date & Time" onchange="get_to_datetime(this.id,'txt_arrval-1')" value="<?= date('d-m-Y H:i') ?>" style="width: 139px;" /></td>

									            <td><input type="text" id="txt_arrval-1" name="txt_arrval-1" class="app_datetimepicker form-control" placeholder="*Arrival Date & Time" onchange="validate_validDatetime('txt_dapart-1','txt_arrval-1')" title="Arrival Date & Time" value="<?= date('d-m-Y H:i') ?>" style="width: 139px;" /></td>
...
$('#txt_dapart-1,#txt_arrval-1').datetimepicker({format:'d-m-Y H:i' });
