...
<div class="app_panel_content Filter-panel">
	<div class="row">
		<div class="col-md-4 col-sm-4 col-xs-12 mg_bt_10_xs">
			<input type="text" id="from_date_filter" name="from_date_filter" placeholder="From Date" title="From Date" onchange="get_to_date('from_date_filter', 'to_date_filter');quotation_list_reflect()">
		</div>
		<div class="col-md-4 col-sm-4 col-xs-12 mg_bt_10_xs">
		...
		<div class="col-md-4 col-sm-4 col-xs-12 mg_bt_10_xs">
			<select name="quotation_id" id="quotation_id" title="Select Quotation" onchange="quotation_list_reflect()" style="width:100%">
				...
				<?php 
				$query = "select * from flight_quotation_master where 1 and financial_year_id='$financial_year_id' ";
...
<div class="row mg_tp_20"> <div class="col-md-12 no-pad"> <div class="table-responsive">
	<table id="flight_table" class="table table-hover" style="width:100%;margin: 20px 0 !important;">       </table>
</div></div></div>
</div>
