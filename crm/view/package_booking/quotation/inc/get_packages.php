                  ...
                  <div class="col-md-12 no-pad" id="div_list1">
                    ...
                    <div class="table-responsive">
                      ...
                      <tr>
                          ...
                          <td><select id="meal_plan<?php echo $offset; ?>"-u title="Meal Plan" name="meal_plan" class="form-control mg_bt_10" style='width: 90px'>
                              <?php if($row_program['meal_plan']!=''){ ?><option value="<?php echo $row_program['meal_plan']; ?>"><?php echo $row_program['meal_plan']; ?></option>
                              <?php } ?>
                              <?php get_mealplan_dropdown(); ?>
                          </select></td>
                          <td class='col-md-1 pad_8'><button type="button" class="btn btn-info btn-iti btn-sm" id="itinerary<?php echo $offset1; ?>" title="Add Itinerary" onClick="add_itinerary('dest_name','special_attaraction<?php echo $offset; ?>-u','day_program<?php echo $offset; ?>-u','overnight_stay<?php echo $offset; ?>-u','Day-<?=$offset1?>')"><i class="fa fa-plus"></i></button>
                          </td>
