...
<table id="refund_history" class="table table-bordered table-hover no-marg">
    ...
    <tr class="<?= $bg ?>">
        ...
        <td><?php echo get_date_user($row_refund['refund_date']) ?></td>
    ...
    <tfoot>
        ...
        <tr class="active">
            ...
            <th colspan="2" class="success">Total_Refund : <?= number_format(($sq_refund['sum'] - $sq_pending['sum'] - $sq_cancel['sum']),2) ?></th>
        </tr>
    </tfoot>
</table>
