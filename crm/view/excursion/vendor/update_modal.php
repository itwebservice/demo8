...
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_vendor[mobile_no]' and vendor_type='Visa'"));
?>
<form id="frm_update">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" class="form-control" id="email_id1" name="email_id1" placeholder="e.g.abc@gmail.com" title="Email ID" value="<?= $sq_vendor['email_id'] ?>">
          </div>  
           <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
          <input type="text" name="bank_name1" id="bank_name1" class="form-control bank_suggest" placeholder="Bank Name" title="Bank Name" value="<?= $sq_vendor['bank_name']?>">
          </div> 
        </div>
        <div class="row">
          <div class="col-md-3 col-sm-6 mg_bt_10">
