<tr>
    ...
    <td><input type="text" style="width:200px" id="exc_date-<?= $offset ?>1" name="exc_date-<?= $offset ?>1" placeholder="Activity Date & Time" title="Activity Date & Time" class="app_datetimepicker" value="<?= date('d-m-Y H:i') ?>" style="width:110px" onchange="get_excursion_amount();"></td>
    ...
    <td><select name="transfer_option-<?= $offset ?>1" id="transfer_option-<?= $offset ?>1" data-toggle="tooltip" class="form-contrl app_select2" title="Transfer Option" style="width:150px" onchange="get_excursion_amount('calculate_exc_expense');">
    ...
    <td><input type="text" id="total_amount-<?= $offset ?>1" name="total_amount-<?= $offset ?>1" placeholder="Total Amount" title="Activity Amount" onchange="validate_balance(this.id)" style="width:110px"></td>
</tr>
