...
$sq_payment_info1 = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sumpay from vendor_payment_master where vendor_type='$vendor' and vendor_type_id='$vendor_id' and estimate_type='$estimate_type' and estimate_type_id='$estimate_type_id' and clearance_status!='Pending' and clearance_status!='Cancelled'"));

$sq_refunded_info1 = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sumpay from vendor_refund_master where estimate_id='$estimate_id' and clearance_status!='Pending' and clearance_status!='Cancelled'"));
                ...
                <div class="stat_content main_block">
                   ...
                   <span class="main_block content_span" data-original-title="" title="">                    
                    ...
                    <span class="main_block content_span" data-original-title="" title="">
                        ...
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= number_format($remaining,2) ?></span>
                    </span>
                </div> 
            </div>
         </div>
