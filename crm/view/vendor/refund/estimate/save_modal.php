...
$sq_est_info = mysqli_fetch_assoc(mysqlQuery("select * from vendor_estimate where estimate_id='$estimate_id'"));
...
<div class="modal fade" id="save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <hr>
      <?php 
      $sq_cancel_count = mysqli_num_rows(mysqlQuery("select * from vendor_estimate where estimate_id='$estimate_id' and status='Cancel'"));
...
$('#frm_estimate').validate({
  ...
  submitHandler:function(form){
      ...
      if(parseFloat(cancel_amount) > parseFloat(total_sale)) { 
        ...
        error_msg_alert("Cancel amount can not be greater than Sale Amount"); return false; 
      }
