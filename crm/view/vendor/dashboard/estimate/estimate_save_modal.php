...
$(document).ready(function(e){
		...
		if(searchParams.get('type')){
			...
			setTimeout(() => {
				...
				else if(type=="Miscellaneous Booking"){
					var purchase_id = 'misc_id';
				}
				else if(type=="Train Ticket Booking"){
					var purchase_id = 'train_ticket_id';
				}
				else if(type=="Ticket Booking"){
					var purchase_id = 'ticket_id';
				}
				else if(type=="Visa Booking"){
					var purchase_id = 'visa_id';
				}
				else if(type=="Excursion Booking"){
					var purchase_id = 'exc_id';
				}
				else if(type=="Car Rental"){
					var purchase_id = 'booking_id';
				}
				else if(type=="Bus Booking"){
					var purchase_id = 'booking_id';
				}
