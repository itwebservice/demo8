...
$sq_vendor_estimate = mysqli_fetch_assoc(mysqlQuery("select * from vendor_estimate where estimate_id='$estimate_id'"));
  ...
  <div class="modal-dialog modal-lg" role="document" style="width:95%; margin-top:20px">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<?php
			$label = ($sq_vendor_estimate['invoice_proof_url'] != '') ? 'Uploaded' : 'Upload Invoice';
			?>
			<div class="row text-right">  
			<div class="col-xs-12">    
			     <div class="div-upload">
	                <div id="id_upload_btn_update" class="upload-button1"><span><?= $label ?></span></div>
...
function upload_hotel_pic_attch()
{
    ...
    var url1 = $("#id_upload_url2").val();
	if(url1 != ''){
		var label = 'Uploaded';
	}else{
		var label = 'Upload Invoice';
	}
