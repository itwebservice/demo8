...
if($estimate_type=='Package Tour'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from package_tour_booking_master where booking_id='$booking_id'"));
...
if($estimate_type=='Bus Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from bus_booking_master where booking_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['net_total'];
    $booking_date = $sq_total_amount['created_at'];
}
if($estimate_type=='Excursion Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from excursion_master where exc_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['exc_total_cost'];
    $booking_date = $sq_total_amount['created_at'];

}
if($estimate_type=='Car Rental'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from car_rental_booking where booking_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['total_fees'];
    $booking_date = $sq_total_amount['created_at'];
}
if($estimate_type=='Group Tour'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from tourwise_traveler_details where booking_id='$booking_id'"));
...
if($estimate_type=='Hotel Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from hotel_booking_master where booking_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['total_fee'];
    $booking_date = $sq_total_amount['created_at'];

}
if($estimate_type=='Miscellaneous Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from miscellaneous_master where misc_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['misc_total_cost'];
    $booking_date = $sq_total_amount['created_at'];

}
if($estimate_type=='Passport Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from passport_master where passport_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['passport_total_cost'];
}
if($estimate_type=='Ticket Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from ticket_master where ticket_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['ticket_total_cost'];
    $booking_date = $sq_total_amount['created_at'];

}
if($estimate_type=='Train Ticket Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from train_ticket_master where train_ticket_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['net_total'];
    $booking_date = $sq_total_amount['created_at'];

}
if($estimate_type=='Visa Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from visa_master where visa_id='$booking_id'"));
    $total_exp_amount = $sq_total_amount['visa_total_cost'];
    $booking_date = $sq_total_amount['created_at'];

}
if($estimate_type=='Forex Booking'){
    $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select * from forex_booking_master
