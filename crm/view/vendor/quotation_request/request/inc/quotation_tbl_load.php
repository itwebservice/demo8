		...
		<table class="table" id="tbl_vendor_quotation_dmc_entries">
			...
			if($request_id=="" || sizeof($dmc_entries)==0){
				...
				<tr style="height: 60px">
					...
					<td><input type="text" id="dmc_id" name="dmc_id" placeholder="Hotel Category" title="Hotel Category"></td>
					<td><input type="text" id="checkin_date" name="checkin_date" onchange="get_to_date(this.id,'checkout_date')" placeholder="Checkin Date" title="Checkin Date" class="app_datepicker"  value="<?= date('d-m-Y') ?>"></td>
					<td><input type="text" id="checkout_date" onchange="validate_issueDate('checkin_date' , 'checkout_date');validate_validDate('checkin_date' , 'checkout_date')"  name="checkout_date" placeholder="Checkout Date" title="Checkout Date" class="app_datepicker"  value="<?= date('d-m-Y') ?>"></td>
