				...
				<table class="table table-bordered no-marg">
					...
					<tbody>
						...
						foreach(array_chunk($transport_entries_arr, 1) as $transport_entries){
							...
							$sq_tr = mysqli_fetch_assoc(mysqlQuery("select transport_agency_id, transport_agency_name from transport_agency_master where transport_agency_id='$arr[transport_agency_id]'"));
