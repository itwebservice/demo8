...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='vendor/quotation_request/index.php'"));
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-2 col-xs-12 mg_bt_10_sm_xs">
              <input type="text" id="to_date" name="to_date" onchange="validate_issueDate('from_date','to_date');validate_validDate('from_date',this.id)" placeholder="*To Date" title="To Date" value="<?= $to_date ?>">
            </div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
              <input type="text" id="cab_type" name="cab_type" placeholder="Cab Type" title="Cab Type">
            </div>
            <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
              <input type="text" id="transfer_type" name="transfer_type" placeholder="Transfer Type" title="Transfer Type">
            </div>
        </div>
      </div>
      ...
      <div class="row"> 
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <textarea id="excursion_specification" class="feature_editor" name="excursion_specification" placeholder="Activity Specification" title="Activity Specification" rows="1"></textarea>
        </div>  
      </div>
      ...
      if(quotation_for=="DMC"){
        ...
        {    
            ...
            if(row.cells[0].childNodes[0].checked)
            {
              ...
              if(room_type == ''){err_msg += "Room Category is required "+(i+1)+"<br>";}
