<?php
$sq_city = mysqli_fetch_assoc(mysqlQuery("select * from city_master where city_id='$sq_req[city_id]'")); ?>
<div class="row">
	<div class="col-md-12">
		<div class="profile_box main_block">
				...
				<div class="row">
					...
					<div class="col-md-6 mg_bt_10">
						<i class="fa fa-angle-double-right"></i>&nbsp;&nbsp;<label>City Name <em>:</em></label>  
						<?php
							$city_name_show = "";
							for($i=0;$i<sizeof($city_id_arr);$i++){ 
								$sq_city = mysqli_fetch_assoc(mysqlQuery("select * from city_master where city_id='$city_id_arr[$i]'"));
								
								$city_name_show .= $sq_city['city_name'].','; 
							} 
							echo rtrim($city_name_show, ',');
						?>
					</div>
					<div class="col-md-6 mg_bt_10">
