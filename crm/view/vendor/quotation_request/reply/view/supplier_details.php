				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						if($sq_req['quotation_for']=="Transport")
			        	  {
							$sq_transport = mysqlQuery("select * from transport_agency_master where city_id='$sq_req[city_id]'");
						...
						if($sq_req['quotation_for']=="DMC"){
							$sq_dmc = mysqlQuery("select * from dmc_master where city_id='$sq_req[city_id]'");
						...
						if($sq_req['quotation_for']=="Hotel"){
						    $sq_hotel = mysqlQuery("select * from hotel_master where city_id='$sq_req[city_id]'");
