  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<?php
		$sq_ledger = mysqlQuery("select * from finance_transaction_master where module_entry_id='$module_entry_id' and module_name = '$module_name' and finance_transaction_id != '$finance_transaction_id' and payment_amount != '0'");
