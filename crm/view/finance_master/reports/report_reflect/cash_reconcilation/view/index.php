...
<div class="modal fade profile_box_modal" id="cash_display_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
							...
							<div class="col-md-12">
								<div class="profile_box main_block">
						        	 	<?php 
											...
											$count = 0;
											$sq_cash = mysqli_fetch_assoc(mysqlQuery($query));
						        	 	?>
						        	 	<div class="row">
										...
										<div class="row">
											<div class="col-md-12 right_border_none_sm">			
								            	...
								            	<table class="table table-hover" id="tbl_list" style="margin: 20px 0 !important;">
													...
													<tbody>
													<?php
													$sq_denom = mysqlQuery("select * from cash_denomination_master where id='$id'");
													 while($row_denom = mysqli_fetch_assoc($sq_denom)){ ?>
														<tr>
										...
										<hr>
						        	 	...
						        	 	<div class="row">
							        	 	<div class="col-md-12">
							                   <?php
												$sq_rec = mysqlQuery("select * from cash_reconcl_master_entries where id='$id'");
												 while($row_rec = mysqli_fetch_assoc($sq_rec)){ ?>
