...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='finance_master/reports/index.php'"));
...
function report_reflect()
{
	...
	$.post('report_reflect/cash_reconcilation/report_reflect.php',{  filter_date : filter_date,branch_admin_id : branch_admin_id ,branch_status:branch_status }, function(data){
...
function excel_report()
{
	...
	window.location = 'report_reflect/cash_reconcilation/excel_report.php?filter_date='+filter_date+'&branch_admin_id='+branch_admin_id+'&branch_status='+branch_status;
}
