...
<div class="modal fade" id="asset_save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
              <select id="asset_type" name="asset_type" onchange="get_assets(this.id)" style="width: 100%" title="Type of Asset">
                ...
                <?php 
                $sq_query = mysqlQuery("select distinct(asset_type) from fixed_asset_master");
          ...
          <div class="row mg_tp_20">
            ...
            <div class="col-md-4">
              <input type="text" name="sold_amount" id="sold_amount" onchange="calculate_profit_loss(this.id,'carrying_amount','')" placeholder="Asset Sold Amount" title="Asset Sold Amount">
            </div>
            <div class="col-md-4">
...
$('#asset_frm_save').validate({
    ...
    submitHandler:function(){
        ...
        var old_sold_amount = $('#sold_amount').val();
        ...
        $.ajax({
          ...
          data:{ branch_admin_id : branch_admin_id, asset_id : asset_id,  asset_ledger : asset_ledger, purchase_date : purchase_date, purchase_amount : purchase_amount, depr_type : depr_type , rate_of_depr : rate_of_depr ,  depr_interval : depr_interval , depr_till_date : depr_till_date, carrying_amount : carrying_amount,sold_amount : sold_amount,profit_loss : profit_loss,remark : remark,evidence_url : evidence_url,old_sold_amount:old_sold_amount },
