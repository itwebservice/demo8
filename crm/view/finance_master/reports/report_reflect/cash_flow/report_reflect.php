		...
		<div class="panel panel-default main_block">
			...
			<!-- List Heading -->
				      	...
				      	while($row_subgroup = mysqli_fetch_assoc($sq_subgroup)){ //Sub groups
							...
							<div class="panel panel-default main_block no-marg">
								...
								<div id="collapse<?= $count_d ?>" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading<?= $count_d ?>">
									<?php
									$q = mysqlQuery("select ledger_id,ledger_name,balance from ledger_master where group_sub_id='$row_subgroup[subgroup_id]'");
									while($row_q = mysqli_fetch_assoc($q)){
						            	...
						            	//Debit Total 
						            	$q1 = "select payment_amount from finance_transaction_master where gl_id='$row_q[ledger_id]' and payment_side='Debit' ";	
										if($to_date!=""){
						            	...
						            	//Credit Total
						            	$q2 = "select payment_amount from finance_transaction_master where gl_id='$row_q[ledger_id]' and payment_side='Credit' ";
										if($to_date!=""){
											$to_date = get_date_db($to_date);
				...
				// while($row_group = mysqli_fetch_assoc($sq_group)){ //Groups
					...
					$total_head_amount_d = 0;
				    $sq_subgroup = mysqlQuery("select subgroup_id,subgroup_id from subgroup_master where group_id='20'");
					while($row_subgroup = mysqli_fetch_assoc($sq_subgroup)){ //Sub groups
						...
						<div class="panel panel-default main_block no-marg">
							...
							<div id="collapse1<?= $count_d ?>" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading1<?= $count_d ?>">
								...
								while($row_q = mysqli_fetch_assoc($q)){
						            ...
						            $q3 = "select payment_amount from finance_transaction_master where gl_id='$row_q[ledger_id]' and payment_side='Debit'";
									if($to_date!=""){
										$to_date = get_date_db($to_date);
									...
									$q4 = "select payment_amount from finance_transaction_master where gl_id='$row_q[ledger_id]' and payment_side='Credit'";
									if($to_date!=""){
										$to_date = get_date_db($to_date);
				...
				<!-- Accordian Start -->
					...
					<div id="collapse2<?= $count_d ?>" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading2<?= $count_d ?>">
						<?php	
						$q = mysqlQuery("select ledger_id,ledger_name,balance from ledger_master where group_sub_id in ('63','41','86','52','5','50','6','53','93')");
						while($row_q = mysqli_fetch_assoc($q)){
				...
				<div class="panel panel-default main_block no-marg">
					...
					<div id="collapse3<?= $count_d ?>" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading3<?= $count_d ?>">
						...
						while($row_q = mysqli_fetch_assoc($q)){
							...
							$q6 = "select payment_amount from finance_transaction_master where gl_id='$row_q[ledger_id]' and payment_side='Debit'";			
							if($to_date!=""){
								$to_date = get_date_db($to_date);
							...
							$q7 = "select payment_amount from finance_transaction_master where gl_id='$row_q[ledger_id]' and payment_side='Credit'";
							if($to_date!=""){
								$to_date = get_date_db($to_date);
			...
			<div class="panel panel-default main_block no-marg">
				...
				<div id="collapse4<?= $count_d ?>" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading4<?= $count_d ?>">
					<?php
					$q = mysqlQuery("select ledger_id,ledger_name,balance from ledger_master where group_sub_id in ('84','44','47','43','75','81','82','59','103','51','35','69','97','98','76','57','88','80','92','72','9','7','8')");
					while($row_q = mysqli_fetch_assoc($q)){
