      ...
      <div class="modal-body profile_box_padding">
      	<div>
			  ...
			  <ul class="nav nav-tabs" role="tablist">
				...
				<?php
				$count_query = mysqli_num_rows(mysqlQuery("select * from bank_reconcl_receipt where id='$id'")); 
				if($count_query > '0'){ ?>
					<div class="row">
							...
							<div class="row">
								<div class="col-md-12 right_border_none_sm">
									<table class="table table-bordered table-hover" id="tbl_list" style="margin: 20px 0 !important;">
										...
										while($sq_bank_receipt = mysqli_fetch_assoc($sq_query)){
											?>
											<tr>
												<td><?= $count++ ?></td>
				...
				<?php
				$count_query = mysqli_num_rows(mysqlQuery("select * from bank_reconcl_payment where id='$id'")); 
				if($count_query > '0'){ ?>
					<div class="row">
					<div class="col-md-12 mg_tp_20">
			...
			<div role="tabpanel" class="tab-pane" id="bank_information">
				<?php
				$count_query = mysqli_num_rows(mysqlQuery("select * from bank_reconcl_debit_for where id='$id'")); 
				if($count_query > '0'){ ?>
					<div class="row">
					<div class="col-md-12 mg_tp_20">
				...
				<?php
				$count_query = mysqli_num_rows(mysqlQuery("select * from bank_reconcl_credit_for where id='$id'")); 
				if($count_query > '0'){ ?>
					<div class="row">
					<div class="col-md-12 mg_tp_20">
