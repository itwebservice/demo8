...
<div class="app_panel_content Filter-panel">
	<div class="row">
		<div class="col-md-3 col-sm-6 mg_bt_10_xs">
			 <input type="text" id="till_datep" name="till_datep" placeholder="Select Date" onchange="report_reflect()" title="Select Date" value="<?= date('d-m-Y') ?>" >
		</div>
...
$('#till_datep').datetimepicker({ timepicker:false, format:'d-m-Y' });
