...
$sq_comp = mysqli_fetch_assoc(mysqlQuery("select * from other_complaince_master where id='$comp_id'"));
?>
...
<div class="modal fade" id="comp_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
