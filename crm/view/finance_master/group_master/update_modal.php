...
$sq_group = mysqli_fetch_assoc(mysqlQuery("select * from subgroup_master where subgroup_id='$group_id'"));
?>
<form id="frm_update">
      ...
      <div class="modal-body">
          ...
          <div class="col-sm-6 mg_bt_10">
            <select id="group_id1" name="group_id1" title="Subgroup" style="width:100%">             
              <?php $sq_subgroup1 = mysqli_fetch_assoc(mysqlQuery("select * from subgroup_master where subgroup_id='$sq_group[group_id]'")); ?>
              <option value="<?php echo $sq_subgroup1['subgroup_id']; ?>"><?php echo $sq_subgroup1['subgroup_name']; ?></option>
              <option value="">*Select Group</option>
              <?php 
              $sq_subgroup = mysqlQuery("select * from subgroup_master where 1 ");
