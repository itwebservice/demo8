...
$sq_gl = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where ledger_id='$ledger_id'"));
?>
<form id="frm_update">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="col-sm-4 mg_bt_10_sm_xs">
            ...
            <?php $sq_group1 = mysqli_fetch_assoc(mysqlQuery("select * from subgroup_master where subgroup_id='$sq_gl[group_sub_id]'")); ?>
