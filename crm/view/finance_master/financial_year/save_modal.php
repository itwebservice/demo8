      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="login_id1" name="login_id" class="form-control" value="<?= $login_id ?>">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 mg_bt_10">
            <input type="text" onchange="get_to_date('from_date','to_date')" id="from_date" name="from_date" class="form-control" placeholder="*From Date" title="From Date" value="<?= date('d-m-Y') ?>">
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12 mg_bt_10">
            <input type="text" id="to_date" name="to_date" class="form-control" placeholder="*To Date" title="To Date" onchange="validate_validDate('from_date','to_date')" value="<?= date('d-m-Y') ?>">
          </div>
          <div class="col-sm-4">
