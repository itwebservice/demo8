...
?>
<form id="frm_save1">
<div class="modal fade" id="journal_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body"> 
		<div class="row"> <div class="col-md-12 mg_tp_20"><div class="table-responsive">
			<table class="table table-hover table-bordered" id="tbl_list_journal_sub" style="margin: 20px 0 !important;  padding: 0px !important;">
				...
				<tbody>
				<?php
					$sq_q = "select * from journal_entry_accounts where entry_id='$entry_id'";
					$sq_journal_info = mysqlQuery($sq_q);
					$count = 1;
					while($row_journal = mysqli_fetch_assoc($sq_journal_info)){
						$sq_le_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where ledger_id='$row_journal[ledger_id]'"));
