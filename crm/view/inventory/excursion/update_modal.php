    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<input type="hidden" value="<?= $entry_id?>" id="entry_id"/>
				...
				<div class="col-sm-4 mg_bt_10_xs">
					<select name="exc_name1" id="exc_name1" title="Select Activity" style="width:100%" disabled>
	...
	$('#frm_save').validate({
		...
		submitHandler:function(form, e){
			...
			$.ajax({
				...
				data:{  entry_id:entry_id,purchase_date : purchase_date,city_id : city_id, exc_name : exc_name ,total_tickets : total_tickets,rate : rate , from_date : from_date , to_date : to_date,cancel_date:cancel_date,reminder1:reminder1,reminder2:reminder2,note:note,active_flag:active_flag},
