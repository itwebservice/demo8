...
<?php 
       $sq_travelers_details = mysqlQuery("select visa_id,entry_id, first_name, last_name from visa_master_entries where visa_id='$booking_id' and status != 'Cancel'  order by visa_id desc"); 
