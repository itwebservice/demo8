...
?>
<!-- Save Modal -->
<div class="modal fade" id="send_modal1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
        <form id="frm_air_send">
            ...
            <input type="hidden" name="booking_type" id="booking_type" value="flight_booking"/>
              <div class="col-sm-4">
                    <select name="flight_id_filter" id="flight_id_filter" style="width:100%" title="Booking ID" onchange="load_passenger(this.id,'flight_booking','flight_status_div1')">
...
<div id="flight_status_div1" class="main_block"></div>
