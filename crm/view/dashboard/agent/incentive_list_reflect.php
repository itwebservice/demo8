...
$emp_id = $_SESSION['emp_id'];
        ...
        $sq_group_bookings = mysqlQuery($query1);
        ...
        while($row_group_bookings = mysqli_fetch_assoc($sq_group_bookings)){
          ...
          $sq_customer = mysqli_fetch_assoc( mysqlQuery("select first_name, last_name from customer_master where customer_id='$customer_id'") );
        ...
        $sq_package_booking = mysqlQuery($query2);
                        ...
                        <?php 
                          ...
                          foreach($booking_array as $booking_array_item){
                            ...
                            if($other_data_arr['tour_type']=="Group Tour"){
                              ...
                              $incentive_count = mysqli_num_rows(mysqlQuery("select * from booker_incentive_group_tour where tourwise_traveler_id='$tourwise_traveler_id' and emp_id='$emp_id'"));
                              $sq_incentive = mysqli_fetch_assoc(mysqlQuery("select * from booker_incentive_group_tour where tourwise_traveler_id='$tourwise_traveler_id' and emp_id='$emp_id'"));
                            ...
                            if($other_data_arr['tour_type']=="Package Tour"){
                              ...
                              $incentive_count = mysqli_num_rows(mysqlQuery("select * from booker_incentive_package_tour where booking_id='$booking_id' and emp_id='$emp_id'"));
                              $sq_incentive = mysqli_fetch_assoc(mysqlQuery("select * from booker_incentive_package_tour where booking_id='$booking_id' and emp_id='$emp_id'"));
