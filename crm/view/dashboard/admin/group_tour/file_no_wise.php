...
$sq_total_travel_paid_amount = mysqli_fetch_assoc(mysqlQuery("select sum(amount) as sum from payment_master where tourwise_traveler_id='$tourwise_id' and payment_for='traveling' "));
?>
<div class="row">
	...
	<div class="panel panel-default panel-body mg_bt_0 mg_bt_10_sm_xs" style="height:270px;">
		...
		<div class="row"> <div class="col-md-12"> <div class="table-responsive">
			...
			<table class="table table-bordered table-hover mg_bt_0">
				...
				<?php
				$count = 0;
				$sq_traveler = mysqlQuery("select * from travelers_details where traveler_group_id='$traveler_group_id'");
