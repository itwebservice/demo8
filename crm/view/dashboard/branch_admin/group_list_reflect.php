...
$query = mysqli_fetch_assoc(mysqlQuery("select max(id) as booking_id from tourwise_traveler_details where financial_year_id='$financial_year_id' and branch_admin_id='$branch_admin_id'"));
