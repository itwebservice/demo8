...
$sq_bus_det = mysqli_fetch_assoc(mysqlQuery("select bus_name from bus_master where bus_id='$bus_id'"));
...
$sq_bus_arr_det = mysqlQuery("select * from bus_seat_arrangment_master where tour_id='$tour_id' and tour_group_id='$tour_group_id' and bus_id='$bus_id' ");
while($row_bus_arr_det = mysqli_fetch_assoc($sq_bus_arr_det))
{
	$count++;

	$sq_travelr_det = mysqli_fetch_assoc(mysqlQuery("select * from travelers_details where traveler_id='$row_bus_arr_det[traveler_id]'"));
