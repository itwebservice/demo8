...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='other_receipts/index.php'"));
...
<div class="row text-right mg_bt_20">
	<div class="col-xs-12">
		...
		<button class="btn btn-info ico_left btn-sm" id="btn_new_income" onclick="income_save_modal()"><i class="fa fa-plus"></i>&nbsp;&nbsp;Customer Advance</button>
	</div>
</div>
	...
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			<select id="cust_id_filter" name="cust_id_filter" style="width:100%" title="Customer" class="form-control">
				<?php get_customer_dropdown($role,$branch_admin_id,$branch_status1); ?>
			</select>
		</div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
