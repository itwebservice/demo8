...
$sq_income_info = mysqli_fetch_assoc(mysqlQuery("select * from other_income_payment_master where payment_id='$payment_id'"));
$sq_income_l = mysqli_fetch_assoc(mysqlQuery("select * from other_income_master where income_id='$sq_income_info[income_type_id]'"));
            ...
            <div class="row">
              <div class="col-md-5 col-sm-6 col-xs-12 mg_bt_10">
                <select name="income_type_id" title="Income Type" id="income_type_id" disabled>
                  <?php 
                  $sq_income = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where ledger_id='$sq_income_l[income_type_id]'"));
                  ?>
