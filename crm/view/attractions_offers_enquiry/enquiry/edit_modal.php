      ...
      <div class="modal-body">
        <form id="frm_emquiry_edit">
                ...
                <div class="row mg_tp_10">
                    ...
                    <div class="col-md-3 col-sm-6 mg_bt_10">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                        <input type="number" class="form-control" id="txt_landline_no_u" onchange="mobile_validate(this.id);" name="txt_landline_no_u" placeholder="WhatsApp No" title="WhatsApp No" value="<?= str_replace($enq_details['country_code'],"",$enq_details['landline_no']) ?>">  
                        </div>
                      </div>      
                    </div>        
                    <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <div class="row"> 
                    ...
                    <div class="col-sm-4 mg_bt_10">
                        <select name="reference_id_u" id="reference_id_u" style="width:100%" title="Reference" onchange="customer_fields_reflect()">
                  ...
                  ?>
                    <div class="col-md-4 col-sm-6 mg_bt_10">
                      <select id="customer_dropdown_u" name="customer_dropdown_u" title="Customer" class="form-control <?= $class ?>" style="width:100%;">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 mg_bt_10_xs">
                        ...
                        <?php 
                        $admin_select_flag = 0;
                        $sq_ass_v = mysqli_fetch_assoc(mysqlQuery("select first_name from emp_master where emp_id=".$enq_details['assigned_emp_id']));
