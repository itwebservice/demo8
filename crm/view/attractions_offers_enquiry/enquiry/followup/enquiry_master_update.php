          ...
          <div class="mg_bt_10">
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 mg_bt_10c">
                      <input type="number" class="form-control" id="txt_mobile_no" name="txt_mobile_no" onchange="mobile_validate(this.id);" placeholder="Mobile Number" title="Mobile No" value="<?= $sq_enquiry['mobile_no'] ?>">            
                  </div>
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <input type="number" class="form-control" id="txt_landline_no" name="txt_landline_no" onchange="mobile_validate(this.id);" placeholder="WhatsApp No with country code" title="WhatsApp No with country code" value="<?= $sq_enquiry['landline_no'] ?>"> 
                  </div>  
                  <div class="col-md-3 col-sm-6 mg_bt_10">
              ...
              <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6 mg_bt_10">
                      <select name="reference_id" id="reference_id" title="Reference" class="form-control" onchange="customer_fields_reflect()">
                          <?php
                          $sq_ref = mysqli_fetch_assoc(mysqlQuery("select * from references_master where reference_id='$sq_enquiry[reference_id]'"));
                          ?>
                          ...
                          <?php }$sq_ref = mysqlQuery("select * from references_master where active_flag!='Inactive'");
                ...
                if($sq_enquiry['reference_id']=='3'){
                ?>
                    <div class="col-md-4 col-sm-6 mg_bt_10">
                      <select id="customer_dropdown" name="customer_dropdown" title="Customer" class="form-control">
                          <?php 
                          if($sq_enquiry['customer_name']!='')
                          { 
                            $sql_cust = mysqli_fetch_assoc(mysqlQuery("select * from customer_master where customer_id='$sq_enquiry[customer_name]'")) ; 
                            ?>
                            <option value="<?= $sq_enquiry['customer_name'] ?>"><?= $sql_cust['first_name'].' '.$sql_cust['last_name'] ?></option>
                          <?php
              ...
              <div class="row mg_bt_20">
                  <div class="col-md-4 col-sm-6 mg_bt_10">
                      <select name="assigned_emp_id" id="assigned_emp_id" title="Allocate To"class="form-control">
                          <?php 
                          $sq_emp = mysqli_fetch_assoc(mysqlQuery("select * from emp_master where emp_id='$sq_enquiry[assigned_emp_id]'"));
                          ?>
