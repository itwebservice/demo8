...
if($enquiry_type=="Flight Ticket"){
	...
	if(isset($_POST['enquiry_id'])){
		...
		$sq_c['budget'] = $sq_c['sector_from'] = $sq_c['sector_to'] = $sq_c['preffered_airline'] = $sq_c['class_type'] = $sq_c['total_adults_flight'] = $sq_c['total_child_flight'] = $sq_c['total_infant_flight'] = $sq_c['total_seats'] = $sq_c['budget'] = $sq_c['to_city_id_flight'] = $sq_c['from_city_id_flight'] = "";
