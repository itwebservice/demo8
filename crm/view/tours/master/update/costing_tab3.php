<form id="frm_tour_update"> 
  <div class="app_panel">
    ...
    <div class="container">
      ...
      &nbsp;&nbsp;
          <button class="btn btn-sm btn-success ico_left" id="btn_quotation_update" >Update<i class="fa fa-floppy-o"></i>&nbsp;&nbsp;</button>
        </div>
      </div>
    </div>
</form>
    ...
    //Daywise program 
        ...
        var rowCount = table.rows.length;
...

            {
              ...
              if(day_program=="") {error_msg_alert("Day-wise program important"); $('#btn_quotation_update').prop('disabled',false);return false;} 
