...
<div class="row mg_bt_10">
    <div class="col-md-12">
        ...
        <table id="tbl_dynamic_cruise_update" name="tbl_dynamic_cruise_update" class="table table-bordered no-marg">
        	...
        	<?php 
        	$sq_cruise_count = mysqli_num_rows(mysqlQuery("select * from group_cruise_entries where tour_id='$tour_id'"));
        	if($sq_cruise_count=='0'){
        		...
        		$count = 0;
        		$sq_q_cruise = mysqlQuery("select * from group_cruise_entries where tour_id='$tour_id'");
