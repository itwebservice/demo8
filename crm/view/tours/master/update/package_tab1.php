    ...
    <div class="container">
      <input type="hidden" id="txt_tour_id" name="txt_tour_id" value="<?php echo $tour_id; ?>">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                <input type="text" id="txt_tour_name" name="txt_tour_name" class="form-control" value="<?php echo $tour_info['tour_name'] ?>" placeholder="Tour Name" onchange="package_name_validation(this.id);(this.id)" title="Tour Name" <?= $readable ?>/>
            </div>
            <div class="col-md-3 col-sm-6 mg_bt_10 ">
                <select id="dest_name_s"  name="dest_name_s" title="Select Destination" class="form-control"  style="width:100%" disabled required>
              ...
              <table style="width:100%;margin: 0 !important;" id="dynamic_table_list1" name="dynamic_table_list">
                ...
                while($sq_pckg1 = mysqli_fetch_assoc($sq_pckg_a)){
                  ...
                  <tr>
                    ...
                    <td class='col-md-1 pad_8'><button type="button" class="btn btn-excel" title="Add Itinerary" id="itineraryu<?php echo $count; ?>" onClick="add_itinerary('dest_name_s','special_attaraction<?php echo $count; ?>-u','day_program<?php echo $count; ?>-u','overnight_stay<?php echo $count; ?>-u','Day-u<?=$count?>')"><i class="fa fa-plus"></i></button>
                    </td>
      ...
      <div class="row mg_bt_10 mg_tp_20 text-center">
        <button class="btn btn-sm btn-info ico_right days" id="btn_update">Next&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
</div>
</form>
