...
<!--=======Header panel======-->
    ...
    <div class="container">
      <div class="row mg_tp_20">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input class="form-control" type="text" onchange="package_name_validation(this.id);" id="txt_tour_name" name="txt_tour_name" placeholder="*Tour Name" title="Tour Name"/>
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10 ">
            <select id="dest_name_s"  name="dest_name_s" title="Select Destination" class="form-control"  style="width:100%" onchange="get_dest_image(this.id)" required> 
          ...
          <div class="col-md-12">
              ...
              <table id="tbl_dynamic_tour_group" name="tbl_dynamic_tour_group" class="table border_0 no-marg" style="padding: 0 !important;">
                  <tr>
                      ...
                      <td><input type="text" id="txt_from_date1" name="txt_from_date1" placeholder="*From Date" title="From Date"  value="<?= date('d-m-Y')?>" onchange="get_to_date(this.id,'txt_to_date1');generate_list();"></td>
                      <td><input type="text" id="txt_to_date1" name="txt_to_date1" placeholder="*To Date" title=" To Date" value="<?= date('d-m-Y')?>" onchange="validate_validDate('txt_from_date1','txt_to_date1');generate_list();"></td>
      ...
      <div class="row mg_bt_10 mg_tp_20 text-center">
          <button class="btn btn-sm btn-info ico_right next_btn">Next&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
      </div>
    </div>
</div>
</form>
...
function get_dest_image(dest_id){
  ...
  $.post('../inc/dest_images_reflect.php', {dest_id : dest_id}, function(data){
...
function incl_reflect(cmb_tour_type)
{
  ...
  $.post('../inc/inclusion_reflect.php', {tour_type : tour_type,type:'' }, function(data){
