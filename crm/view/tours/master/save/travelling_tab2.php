								...
								<div class="panel-body">
									<div class="row mg_bt_10">
										<div class="col-md-12 text-right text_center_xs">
											<button type="button" class="btn btn-excel btn-sm" onClick="addRow('tbl_group_tour_save_dynamic_train');city_lzloading('.trainfrom','*From',true);city_lzloading('.trainto','*To',true)"><i class="fa fa-plus"></i></button>
