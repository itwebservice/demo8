...
$sq_enq_info = mysqli_fetch_assoc(mysqlQuery("select * from car_rental_booking where booking_id='$booking_id'"));
          ...
          <div class="panel panel-default panel-body app_panel_style feildset-panel">
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                $year = $yr[0];
                $sq_name = mysqli_fetch_assoc(mysqlQuery("select * from enquiry_master where enquiry_type='Car Rental' and enquiry_id='$sq_enq_info[enquiry_id]'"));
                ($sq_enq_info['quotation_id'] == "0") ? $quo_id = "Without Quotation" : $quo_id = get_quotation_id($sq_enq_info['quotation_id'], $year);
                ?>
                <input type="text" name="quotation_id" id="quotation_id" value="<?php echo $quo_id  ?>" readonly>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select name="vehicle_name1" id="vehicle_name1" title="Vehicle Name" class="form-control" onchange="get_capacity(this.id,'1')">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select name="travel_type1" id="travel_type1" title="Travel Type" class="form-control" onchange="reflect_feilds();" disabled>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <textarea type="text" name="local_places_to_visit1" onchange="validate_spaces(this.id)" id="local_places_to_visit1" placeholder="Route" title="Route" rows="1"><?= $sq_enq_info['local_places_to_visit'] ?></textarea>
                <select name="places_to_visit1" id="places_to_visit1" title="Places To visit" class="form-control" onchange="get_car_cost();">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <input type="text" id="from_date1" name="from_date1" placeholder="From Date" title="From Date" class="form-control" value="<?= date('d-m-Y', strtotime($sq_enq_info['from_date'])) ?>" onchange="get_to_date(this.id,'to_date1');total_days_reflect('1');;calculate_total_fees(this.id, '1')">
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="panel panel-default panel-body app_panel_style feildset-panel">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                    <input type="text" id="state_entry_tax1" name="state_entry_tax1" class="text-right form-control" placeholder="State Entry" title="State Entry" onchange="calculate_total_fees(this.id, '1');validate_balance(this.id)" value="<?= $sq_enq_info['state_entry_tax'] ?>">
                  </div>
                  <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
<script>
  ...
  function reflect_feilds() {
    ...
    if (type == 'Outstation') {
      ...
      $('#from_date1,#to_date1,#total_max_km1,#driver_allowance1,#permit_charges1,#toll_and_parking1,#state_entry_tax1,#other_charges1,#places_to_visit1,#traveling_date1').show();
    }
  }
  reflect_feilds();
  $(function() {
