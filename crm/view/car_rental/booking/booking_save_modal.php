...
<form id="frm_booking_save">
  ...
  <div class="modal fade" id="booking_save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
          ...
          <div class="panel panel-default panel-body app_panel_style feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select name="vehicle_name" id="vehicle_name" title="Vehicle Name" class="form-control" onchange="get_car_cost();get_capacity(this.id,'')">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <input type="text" id="places_to_visit" name="places_to_visit" class="form-control route_suggest" placeholder="Route" title="Route" onchange="get_car_cost();">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="panel panel-default panel-body app_panel_style feildset-panel">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                    <input type="text" id="state_entry_tax" name="state_entry_tax" class="text-right form-control" placeholder="State Entry" title="State Entry" onchange="calculate_total_fees(this.id);validate_balance(this.id)">
                  </div>
                  <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                    ...
                    <input type="text" id="basic_amount" name="basic_amount" class="text-right form-control" placeholder="*Basic Amount" title="Basic Amount" onchange="calculate_total_fees(this.id);validate_balance(this.id);get_auto_values('balance_date','basic_amount','payment_mode','service_charge','markup_cost','save','true','basic',true);" readonly>
                  </div>
                  <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                    <small id="service_show">&nbsp;</small>
                    <input type="text" name="service_charge" id="service_charge" class="text-right form-control" placeholder="Service Charge" title="Service Charge" onchange="validate_balance(this.id);get_auto_values('balance_date','basic_amount','payment_mode','service_charge','markup_cost','save','true','service_charge')">
                  </div>
                  <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                    <small>&nbsp;</small>
...
<script>
  ...
  function reflect_feilds() {
    ...
    if (type == 'Outstation') {
      ...
      $('#from_date,#to_date,#total_max_km,#driver_allowance,#permit_charges,#toll_and_parking,#state_entry_tax,#other_charges,#places_to_visit,#traveling_date').show();
    }
  }
          ...
          if (data !== 'valid') {
            ...
            return false;
              ...
              $.post(base_url + 'view/load_data/finance_date_validation.php', {
                ...
                function saveData() {
                          $.post(base_url + 'controller/car_rental/booking/booking_save.php', {
                            emp_id: emp_id,
                            ...
                            credit_card_details: credit_card_details
                              ...
                              if (msg[0] == 'error') {
                                ...
                                window.open(base_url+'view/vendor/dashboard/estimate/estimate_save_modal.php?type=Car Rental&amount='+basic_amount+'&booking_id='+msg1[1]);
                                setTimeout(() => {
