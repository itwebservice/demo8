...
<div class="app_panel_content">
	...
	<div class="app_panel_content Filter-panel">
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
				<input type="text" id="traveling_date_from_filter" name="traveling_date_from_filter" placeholder="From Date" title="From Date" onchange="validate_validDate('traveling_date_from_filter','traveling_date_to_filter');get_to_date(this.id,'traveling_date_to_filter');">
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
<script>
	...
	function customer_booking_load(from, to)
	{
		...
		$.post('customer_booking_load.php', { customer_id : customer_id }, function(data){
			$('#'+to).html(data);
			$('#'+to).val('');
			$('#'+to).trigger('change');
		});
	...
	function booking_list_reflect() {
		...
		$.post('booking_list_reflect.php', {
			...
			pagination_load(data, columns, true, true, 10, 'car_rental_book');
			$('.loader').remove();
		});
	}
	...
	function excel_report() {
		...
		window.location = 'excel_report.php?customer_id=' + customer_id + '&from_date=' + from_date + '&to_date=' + to_date + '&cust_type=' + cust_type + '&company_name=' + company_name + '&branch_status=' + branch_status+'&booking_id_filter='+booking_id_filter;
	}
