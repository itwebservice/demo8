          ...
          <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
            ...
            <div class="row mg_bt_10">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <input type="text" id="basic_cost" name="basic_cost" placeholder="*Amount" title="Amount" onchange="calculate_total_amount();get_auto_values('balance_date','basic_cost','payment_mode','service_charge','markup','save','true','basic','discount',true);validate_balance(this.id)">
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <small id="service_show" style="color:#000000">&nbsp;</small>
                <input type="text" id="service_charge" name="service_charge" placeholder="Service Charge" title="Service Charge" onchange="calculate_total_amount();validate_balance(this.id);get_auto_values('balance_date','basic_cost','payment_mode','service_charge','markup','save','true','service_charge','discount',true)">
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <small>&nbsp;</small>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <input type="text" id="markup" name="markup" placeholder="Markup " title="Markup" onchange="calculate_total_amount();get_auto_values('balance_date','basic_cost','payment_mode','service_charge','markup','save','true','markup','discount',true);validate_balance(this.id)">
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <small>&nbsp;</small>
                        ...
                        $.ajax({
                          ...
                          success: function(result) {
                            ...
                            if (msg[0] == 'error') {
                              ...
                              list_reflect();
                              window.open(base_url+'view/vendor/dashboard/estimate/estimate_save_modal.php?type=Bus Booking&amount='+basic_cost+'&booking_id='+msg1[1]);
                              setTimeout(() => {
