	...
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			<select name="booking_id" id="booking_id" style="width:100%" title="Select Booking">
		        ...
		        <?php 
		        $sq_booking = mysqlQuery("select * from bus_booking_master where booking_id in(select booking_id from bus_booking_entries where status='Cancel')  order by booking_id desc");
