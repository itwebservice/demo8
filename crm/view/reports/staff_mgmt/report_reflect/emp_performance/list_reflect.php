...
<table class="table table-hover" id="tbl_performance_list" style="margin: 20px 0 !important;">
	<thead>
		<tr class="table-heading-row">
		    ...
		    <th class="text-center">Analytical_Skills</th>  
		    <th class="text-center">Ethics</th>
		    <th class="text-center">Conceptual_Thinking</th>
		    <th class="text-center">Average_Rating</th>  
		</tr>
	</thead>
	<tbody>
		<?php 
		...
		while($row_c = mysqli_fetch_assoc($sq_c)){
			...
			$sq_emp = mysqli_fetch_assoc(mysqlQuery("select * from emp_master where emp_id='$row_c[emp_id]'"));
