...
if($from_date!="" && $to_date!=""){
    ...
    $sq_emp2 = mysqli_fetch_assoc(mysqlQuery("select * from emp_master where emp_id='$sq_eq_emp[assigned_emp_id]'"));
    ...
    $sq_emp1 = mysqli_fetch_assoc(mysqlQuery("select * from emp_master where emp_id='$sq_eq_emp1[assigned_emp_id]'"));
}
?>
            ...
            <div class="widget_parent">
                <div class="stat_content main_block">
                    <span class="main_block content_span" data-original-title="" title="">
                        ...
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= ($sq_high_count==0)?0:$sq_high_count ?></span>
                    </span>
                    <span class="main_block content_span" data-original-title="" title="">
                        <span class="stat_content-tilte pull-left" data-original-title="" title="">Enquiry type having highest dropped enquiries</span>
                        <span class="stat_content-amount pull-right" data-original-title="" title=""> <?= ($sq_drop_type['enquiry_type']=='')?'NA':$sq_drop_type['enquiry_type'] ?></span>
                    </span> 
                </div>   
            </div>
        </div>
            ...
            <div class="widget_parent">
                <div class="stat_content main_block">
                    <span class="main_block content_span" data-original-title="" title="">
                        ...
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= ($sq_emp2['emp_id']!='')?$sq_emp2['first_name'].' '.$sq_emp2['last_name']:'NA'?></span>
                    </span>
                    <span class="main_block content_span" data-original-title="" title="">
                        <span class="stat_content-tilte pull-left" data-original-title="" title="">Highest Converted enquiries from</span>
                        <span class="stat_content-amount pull-right" data-original-title="" title=""> <?= ($sq_emp1['emp_id']!='')?$sq_emp1['first_name'].' '.$sq_emp1['last_name']:'NA'?></span>
                    </span> 
                </div>   
            </div>
        </div>
