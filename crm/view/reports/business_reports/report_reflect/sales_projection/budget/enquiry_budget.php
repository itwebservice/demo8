...
$bud_strong_f1 = $_SESSION['bud_strong_f1'];
$bud_hot_f = $_SESSION['bud_hot_f'];
$bud_hot_f1 = $_SESSION['bud_hot_f1'];
$bud_cold_f = $_SESSION['bud_cold_f'];
$bud_cold_f1 = $_SESSION['bud_cold_f1'];
...
$pro_s_f1 = $_SESSION['pro_s_f1'];
$pro_c_f = $_SESSION['pro_c_f'];
$pro_c_f1 = $_SESSION['pro_c_f1'];
$pro_h_f = $_SESSION['pro_h_f'] ;
$pro_h_f1 = $_SESSION['pro_h_f1'] ;
