    ...
    <table class="table table-hover" id="tbl_list" style="margin: 20px 0 !important;">
        ...
        <tbody>
            ...
            while($row = mysqli_fetch_assoc($sq)){
                ...
                if($sq_query_cust['type']=='Corporate'||$sq_query_cust['type'] == 'B2B'){
                    $customer_name = $sq_query_cust['company_name'];
                }else{
                    $customer_name = $sq_query_cust['first_name'].' '.$sq_query_cust['last_name'];
                }
            ?>
                <tr>
                    <td><?= ++$count ?></td>
