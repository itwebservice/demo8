...
$sql = mysqlQuery("SELECT SUM(amount) as total FROM payment_master where tourwise_traveler_id ='$tourwise_traveler_id' and payment_for = 'Travelling' and clearance_status!='Pending' AND clearance_status!='Cancelled'");
$row = mysqli_fetch_array($sql);
$traveling_amount_paid = $row['total'];

$sql1 = mysqlQuery("SELECT SUM(amount) as total FROM payment_master where tourwise_traveler_id ='$tourwise_traveler_id' and payment_for = 'Tour' and clearance_status!='Pending' AND clearance_status!='Cancelled' ");
