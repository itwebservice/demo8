...
<div class="modal fade" id="branch_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
        ...
        <div class="row"> <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 mg_bt_10">
              <input type="text" id="acc_name" name="acc_name" placeholder="A/c Type" title="A/c Type" value="<?= $sq_branch['acc_name'] ?>">
            </div>
            <div class="col-sm-4 mg_bt_10">
