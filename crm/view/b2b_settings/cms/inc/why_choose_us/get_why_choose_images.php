...
?>
<div class="modal fade" id="images_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
            ...
            <div class="panel panel-default panel-body app_panel_style feildset-panel">
                ...
                <div class="c-radioIcon type-image">
                    ...
                    <label for="image_select<?php echo $i; ?>" class="iconWrap" >
                        <img src="<?php echo $image_path; ?>" id="image<?php echo $i; ?>">
                    </label>
                </div>
                <?php } ?>
                </div>
