...
<div class="row mg_bt_20">
    ...
    <div class="col-md-6 mg_tp_10">
        ...
        <input type="text" id="copyright_text" data-toggle="tooltip" placeholder="Copyright Text" title="Copyright Text" value="<?= $query1['footer_strip'] ?>" onchange="validate_char_size(this.id,60);"/>
    </div>
</div>
