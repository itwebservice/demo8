...
$sq_tour_group =mysqli_fetch_assoc(mysqlQuery("select * from tour_groups where tour_id='$sq_checklist[tour_id]' and group_id='$sq_checklist[tour_group_id]'"));
...
$sq_tour =mysqli_fetch_assoc(mysqlQuery("select * from tour_master where tour_id='$sq_checklist[tour_id]'"));
