...
$sq_payment = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sum from car_rental_payment where payment_id in ('$payment_id_arr1')"));
...
{
	$sq = mysqlQuery("select * from car_rental_payment where payment_id='$payment_id_arr[$i]'");
