...
// var_dump($tour_groups_array[0]);
// echo $tour_groups_array[0]->days;
...
var_dump($hotel_costing_array[0]->hotel_contracted_costing_array[0]->room_category);

echo "<br/>=================== <h3 style='margin:0px;color:red;background-color: lightpink;'>Activity</h3> ===================<br/>";
var_dump($cached_array[0]->activity_data);

echo "<h3 style='margin:0px;'>".$cached_array[0]->activity_data[1]->activity_name."</h3>";

echo "<h3 style='margin:0px;margin-top:10px'>======================= Activity(Images) ===========================</h3><br/>";
// var_dump(json_decode($cached_array[0]->activity_data[1]->images_array));
$images = json_decode($cached_array[0]->activity_data[1]->images_array);
echo $images[0]->image_url.'<br/>';
...
// $a = json_decode($cached_array[0]->cms_data[0]->book_enquiry_button);
// echo $a[0]->button_type;
// echo '<br/><br/>';
// // $arr = json_decode($cached_array[0]->cms_data[0]->banner_images);
// // for($i=0;$i<sizeof($arr);$i++){
// //     echo $arr[$i]->image_url.'<br/>';
// // }
// var_dump($cached_array[0]->gallary_array);

// echo "<br/>=================== <h3 style='margin:0px;color:red;background-color: lightpink;'>Cities</h3> ===================<br/>";
// var_dump($cached_array[0]->cities);
echo "<br/>=================== <h3 style='margin:0px;color:red;background-color: lightpink;'>Destinations</h3> ===================<br/>";
var_dump($cached_array[0]->destinations);
?>