<div class="modal fade" id="email_id_save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<form id="frm_email_id_save">
      	...
      	<div class="row">
      		<div class="col-md-6">
      			<input type="text" id="email_id1" name="email_id1" class="form-control" placeholder="*Email ID" title="Email ID" onchange="validate_email(this.id)">
      		</div>
      		<div class="col-md-6">
