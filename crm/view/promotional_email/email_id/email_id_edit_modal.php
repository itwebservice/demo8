...
$sq_email_id_info = mysqli_fetch_assoc(mysqlQuery("select * from sms_email_id where email_id_id='$email_id_id'"));
?>
<div class="modal fade" id="email_id_update_modal"  role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input type="hidden" id="email_id_id" name="email_id_id" value="<?= $email_id_id ?>">
      	...
      	<div class="row">
      		<div class="col-md-6">
      			<input type="text" id="email_id1" name="email_id1" value="<?= $sq_email_id_info['email_id'] ?>" placeholder="Email ID" title="Email ID" onchange="validate_email(this.id)">
      		</div>
      		<div class="col-md-6">
