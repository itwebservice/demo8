...
if($condition == "1"){
    ...
    $sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='customer_master/index.php'"));
    ...
    $html = $sq_airline = mysqlQuery("select * from airline_master where active_flag!='Inactive' order by airline_name asc");
