...
$type = $_POST['type'];
$input_tax_name = $_POST['tax_name'];

if($type != "rule_master"){
  $tax_name = $input_tax_name;
}else{
  $tax_name = '';
}
?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frm_tax_rules_save">
          ...
          <div class="row mg_bt_10"> 
              <div class="col-md-3">
                  <input type="text" placeholder="*Name" title="Name" id="name" value="<?= $tax_name ?>" class="form-control" required />
              </div>
              <div class="col-md-3">
          ...
          <div class="row mg_tp_20">
            <div class="col-md-3">
              <input type="checkbox" id="applicable" name="applicable" autocomplete="off" data-original-title="" title="" aria-hidden="true" class="labelauty" style="display: none;" onclick="inclusive_checker();discount_on_purchase();">
