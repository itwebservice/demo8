...
<form id="frm_cred_info">
	<div class="row mg_tp_20 mg_bt_20 text-right">
		<div class="col-xs-12">
			<button type="button" class="btn btn-sm btn-success ico_left" data-toggle="modal" data-target="#c_view_modal" id="btn_view">&nbsp;&nbsp;View Format<i class="fa fa-eye"></i></button>
		</div>
	</div>
	...
	<div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_30">
		...
		<div class="row mg_tp_20 mg_bt_20">
			...
			<div class="col-md-5">
				<input name="ip_address" class="form-control" onchange="ValidateIPaddress(this.id,true);" title="Enter IP Addresses" id="ip_address" data-role="tagsinput" value="<?= $sq_settings['ip_addresses'] ?>" />
			</div>
			<div class="col-md-5 no-pad">
				<h6 style="color:red;">Note : Use this IP address field only when you don't want to enable login for outside IP addresses.(e.g-192.168.2.1). If not so then keep this field blank</h6>
			</div>
		</div>
	</div>
...
<div class="modal fade profile_box_modal" id="c_view_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
