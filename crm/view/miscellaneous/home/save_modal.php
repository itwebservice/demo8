...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='miscellaneous/index.php'"));
							...
							function saveData() {
								...
								function (data) {
									...
									if (msg[0] == 'error') {
										...
										window.open(base_url+'view/vendor/dashboard/estimate/estimate_save_modal.php?type=Miscellaneous Booking&amount='+misc_issue_amount+'&booking_id='+msg1[1]);
										setTimeout(() => {
