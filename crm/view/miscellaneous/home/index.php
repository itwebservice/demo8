...
<div class="row text-right mg_bt_20">
	<div class="col-xs-12">
		...
		<button class="btn btn-info btn-sm ico_left mg_bt_10_sm_xs" onclick="save_modal()"><i class="fa fa-plus"></i>&nbsp;&nbsp;Miscellaneous</button>
	</div>
</div>
...
<script>
	...
	function whatsapp_send(emp_id, customer_id, booking_date, base_url,contact_no,email_id) {
		$.post(base_url + 'controller/miscellaneous/whatsapp_send.php', {
			...
			customer_id: customer_id,contact_no:contact_no,email_id:email_id
		}, function(data) {
			window.open(data);
		});
	}
	function save_modal(){
		...
		var base_url = $('#base_url').val();
		$.post(base_url + 'view/miscellaneous/home/save_modal.php', {
		}, function(data) {
			$('#save_html').html(data);
		});
	}
