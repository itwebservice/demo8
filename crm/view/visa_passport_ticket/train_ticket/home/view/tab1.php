				...
				<div class="row">
					...
					<div class="col-sm-6 col-xs-12">
						...
						<span class="main_block">
							<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
							<?php
							$sq_credit = mysqli_fetch_assoc(mysqlQuery("SELECT sum(`credit_charges`) as sumc FROM `train_ticket_payment_master` WHERE train_ticket_id='$sq_booking[train_ticket_id]' and `clearance_status`!='Cancelled' and clearance_status != 'Pending'"));
				...
				<div class="table-responsive">
					...
					<table id="tbl_dynamic_passport" name="tbl_dynamic_passport" class="table table-bordered no-marg">
						...
						<tbody>
							<?php
							$offset = "_u";
							$sq_entry_count = mysqli_num_rows(mysqlQuery("select * from train_ticket_master_entries where train_ticket_id='$train_ticket_id'"));
							if ($sq_entry_count == 0) {
