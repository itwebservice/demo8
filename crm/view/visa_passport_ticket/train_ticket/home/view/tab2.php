	            ...
	            <table class="table table-bordered no-marg">
	            	<thead>
	               	...
	               	<tbody>
			            <?php
				            $count = 0;
				    		$sq_ticket= mysqlQuery("select * from train_ticket_master_trip_entries where train_ticket_id='$train_ticket_id'"); 
				    		while($row_entry = mysqli_fetch_assoc($sq_ticket)){
							$count++; 						
			    		?>
							<tr>
							    ...
							    <td><?php echo date("d-m-Y H:i", strtotime($row_entry['travel_datetime'])); ?></td>
							    <td>
							    	<?php echo date("d-m-Y H:i", strtotime($row_entry['arriving_datetime'])); ?>
							    </td>
							</tr>  
	               		<?php
	               		}
