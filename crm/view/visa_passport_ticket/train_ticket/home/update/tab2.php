				...
				<div class="dynform-item">	
					...
					<div class="row">
						<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
							<input type="text" id="travel_datetime-<?= $count ?>" name="travel_datetime" placeholder="Departure Date-Time" title="Departure Date-Time" class="app_datetimepicker travel_datetime" data-dyn-valid="required" value="<?= get_datetime_user($row_entry['travel_datetime']) ?>" onchange="get_arrival_dateid(this.id);">
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
							<input type="text" id="arriving_datetime-<?= $count ?>"  name="arriving_datetime" placeholder="Arrival Date-Time" title="Arrival Date-Time" class="app_datetimepicker arriving_datetime" data-dyn-valid="required" value="<?= get_datetime_user($row_entry['arriving_datetime']) ?>">
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
