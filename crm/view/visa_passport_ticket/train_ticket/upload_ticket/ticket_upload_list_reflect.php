...
$train_ticket_count = mysqli_num_rows(mysqlQuery($query));
?>
<div class="main_block mg_tp_20 mg_bt_10" style="padding-right: 15px; ">
	...
	<div class="pull-right">
		<span style="color: red;">Note : Upload PDF,JPG,PNG Format.&nbsp;&nbsp;&nbsp;</span></div>
</div>
...
<table class="table table-bordered table-hover text-center" id="train_upload_ticket" style="margin: 20px 0 !important;">
	...
	<tbody>
		<?php 
		$count = 0;
		$sq_tickets = mysqlQuery("select * from train_ticket_master_upload_entries where train_ticket_id='$train_ticket_id'");
		while($row_ticket = mysqli_fetch_assoc($sq_tickets)){
