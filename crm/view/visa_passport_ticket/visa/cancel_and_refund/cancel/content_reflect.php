...
<div class="row mg_tp_20 mg_bt_20">
	...
	<div class="col-md-10  col-md-offset-1 col-sm-12 col-xs-12">
		<div class="widget_parent-bg-img bg-img-red">
			...
			$content_arr = array(number_format($visa_amount, 2), number_format($service_charge, 2), number_format($service_tax_amount, 2), number_format($sq_visa_info['markup'], 2), number_format($markupservice_tax_amount, 2), number_format($sq_visa_info['roundoff'], 2), number_format($sq_visa_info['visa_total_cost'], 2), number_format($sq_payment_info['sum'], 2));
