    ...
    <div class="modal-content">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
           ...
           <div class="col-sm-3 col-xs-6 mg_bt_10">
            <select name="state" class="form-control" id="state" title="Select State" style="width: 100%" required>
      ...
      <legend>Bank Information</legend>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
             <input type="text" class="form-control" id="supp_pan" name="supp_pan" onchange="validate_alphanumeric(this.id)" placeholder="PAN/TAN No" title="PAN/TAN No" style="text-transform: uppercase;">
          </div>   
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="hidden" class="form-control" id="opening_balance" name="opening_balance" placeholder="Opening Balance" title="Opening Balance" value="0.00"  onchange="validate_balance(this.id)">
          </div>
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <select class="hidden" class="form-control" name="side" id="side" title="Select side">
