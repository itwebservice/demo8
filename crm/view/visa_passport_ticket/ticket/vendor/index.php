...
<div class="row text-right mg_bt_20">
	<div class="col-md-12">
		<button class="btn btn-info btn-sm ico_left" onclick="save_modal()" id="btn_save_flight"><i class="fa fa-plus"></i>&nbsp;&nbsp; Flight Ticket Supplier</button>
	</div>
</div>
...
function save_modal()
{
	$('#btn_save_flight').button('loading');
	$.post('save_modal.php', {}, function(data){
		$('#btn_save_flight').button('reset');
