<tr>
    ...
    <td><input type="text" id="baggage_info1" name="baggage_info" onchange="validate_spaces(this.id)" placeholder="Baggage" title="Baggage"></td>
    <td><input type="text" id="seat_no1" name="seat_no" onchange="validate_spaces(this.id)" placeholder="Seat No." title="Seat No."></td>
    <td><input type="text" id="meal_plan1" name="meal_plan" placeholder="Meal Plan" title="Meal Plan"></td>
    <td><input type="hidden" id="main_ticket1" name="main_ticket" style="text-transform: uppercase;" onchange="validate_spaces(this.id)" placeholder="*Main Ticket Number" class="form-control main_ticket" title="Main Ticket Number"></td>
</tr>
