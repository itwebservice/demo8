<form id="frm_tab1">
	...
	<div class="row">
        ...
        <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10 hidden" id="company_div">
  ...
  <div class="panel panel-default panel-body app_panel_style feildset-panel">
    ...
    <div class="row text-right mg_bt_10">
        <div class="col-xs-12">
            ...
            <span style="color: red;line-height: 35px;" data-original-title="" title="" class="note">Pls add multiple seat number of multi trip using '/' in between like S1/D3/NA. And similar for Meal plan field.</span>

            <button type="button" class="btn btn-info btn-sm ico_left mg_bt_10_sm_xs" onClick="addRow('tbl_dynamic_ticket_master');ticket_reissue();"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</button>
...
$('#frm_tab1').validate({
    ...
    e.preventDefault();
        ...
        if(row.cells[12].childNodes[0].getAttribute('type')=="text" && main_ticket==""){ msg +="Main Ticket Number is required in row:"+(i+1)+"<br>"; }
