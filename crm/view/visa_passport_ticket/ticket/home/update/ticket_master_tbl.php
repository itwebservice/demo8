	...
	while($row_entry = mysqli_fetch_assoc($sq_entry)){
		...
		?>
		 <tr class="<?= $bg ?>">
			...
			<td><input type="text" id="baggage_info<?= $count ?>_u"  name="baggage_info" placeholder="Baggage" onchange="validate_spaces(this.id)" title="Baggage" value="<?= $row_entry['baggage_info'] ?>"></td>
			<td><input type="text" id="seat_no<?= $count ?>_u" name="seat_no" onchange="validate_spaces(this.id)" placeholder="Seat No." title="Seat No." value="<?= $row_entry['seat_no'] ?>"></td>
			<td><input type="text" id="meal_plan<?= $count ?>_u" name="meal_plan" placeholder="Meal Plan" title="Meal Plan" value="<?= $row_entry['meal_plan'] ?>"></td>
