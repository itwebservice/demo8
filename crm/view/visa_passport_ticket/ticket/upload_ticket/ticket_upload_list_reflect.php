...
$ticket_count = mysqli_num_rows(mysqlQuery("select * from ticket_master_upload_entries where ticket_id='$ticket_id'"));
?>
...
<table class="table table-bordered table-hover text-center" id="flight_upload_ticket" style="margin: 20px 0 !important;">
	...
	<tbody>
		<?php 
		$count = 0;
		$sq_tickets = mysqlQuery("select * from ticket_master_upload_entries where ticket_id='$ticket_id'");
