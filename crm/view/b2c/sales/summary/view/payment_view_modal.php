...
$sq_c = mysqli_num_rows(mysqlQuery("SELECT * FROM b2c_payment_master WHERE booking_id = '$booking_id' and payment_amount!='0' "));
?>
            ...
            if($sq_c>0){ ?>
                  ...
                  <table  class="table table-bordered no-marg">
                    ...
                    <tbody>
                      <?php
                      $count = 0;
                      $sq_query = mysqlQuery("SELECT * FROM b2c_payment_master WHERE booking_id = '$booking_id' and payment_amount!=0");
                        ...
                        $bg='';
                          ...
                          <tr class="<?=$bg?>">
                            ...
                            <td><?php echo $row_entry['payment_mode']; ?></td>
								            <td><?php echo ($row_entry['payment_mode'] == 'Online') ? $row_entry['payment_id'] : 'NA'; ?></td>
                            <td><?php echo $row_entry['bank_name']; ?></td>
                            <td><?php echo $row_entry['transaction_id']; ?></td>
