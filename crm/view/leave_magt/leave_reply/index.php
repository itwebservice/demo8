...
/*======******Header******=======*/
$sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='leave_magt/index.php'"));
...
<div class="app_panel_content Filter-panel">
  ...
  <input type="hidden" name="branch_statusr" id="branch_statusr" value="<?= $branch_status ?>">
      <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">

        <select name="emp_id" id="emp_id_reply1"  class="form-control" style="width: 100%;" title="User Name" title="User Name">

          <option value="">Select User</option>
          <?php
            if($role=='Admin' || ($branch_status!='yes' && $role=='Branch Admin') || ($branch_status!='yes' && $role=='Hr') || ($branch_status!='yes' && $role=='Accountant')){
