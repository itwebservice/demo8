...
$sq_req = mysqli_fetch_assoc(mysqlQuery("select * from leave_request where emp_id='$emp_id' and request_id='$request_id'"));
$sq_emp = mysqli_fetch_assoc(mysqlQuery("select * from emp_master where emp_id='$sq_req[emp_id]'"));
          ...
          <div class="row mg_bt_10 hidden">
		    ...
		    <div class="row mg_bt_10">
                ...
                <div class="col-md-2 text-right"><label for="from_date">From Date</label></div>                 
		             <div class="col-sm-4 col-xs-12">
		              <input type="text" id="from_date" name="from_date" placeholder="*From Date" title="From Date" onchange="get_to_date(this.id,'to_date');total_days_reflect()" value="<?= date('d-m-Y',strtotime($sq_req['from_date'])) ?>">
		            </div>
		    </div> 
		    ...
		    <div class="row mg_bt_10">
	        	<div class="col-md-2 text-right"><label for="to_date">To Date</label></div> 
	             	<div class="col-sm-4 col-xs-12">
	              		<input type="text" id="to_date" name="to_date" placeholder="*To Date" title="To Date" onchange="validate_validDate('from_date','to_date');total_days_reflect()" value="<?= date('d-m-Y',strtotime($sq_req['to_date'])) ?>">
	            	</div> 
