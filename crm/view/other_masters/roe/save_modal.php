  ...
  <div class="modal-dialog modal-sm" role="document" style='width:50%;'>
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add ROE</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="row"> <div class="col-md-12"> <div class="table-responsive">
          <table id="tbl_roe_master" name="tbl_roe_master" class="table table-bordered table-hover table-striped no-marg pd_bt_51 mg_bt_0">
              <tr>
                  ...
                  <td style="width: 150px;"><select name="currency_code" id="currency_code" class="form-control app_select2" title="Select Currency" style="width:150px">
