...
$state_id = $_POST['id'];  
$sq = mysqli_fetch_assoc(mysqlQuery("select * from state_master where id='$state_id'"));
?>

<form id="frm_city_master_update">
<input type="hidden" id="state_id" name="state_id" value="<?= $state_id ?>">

<div class="modal fade" id="state_master_update_modal" data-backdrop="static" data-keyboard="false"  role="dialog" aria-labelledby="myModalLabel">
