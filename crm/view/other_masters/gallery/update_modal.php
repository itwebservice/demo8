...
$sq_dest =  mysqli_fetch_assoc(mysqlQuery("select * from destination_master where dest_id = '$sq_gallary[dest_id]'"));
?>
<form id="frm_update">
<div class="modal fade" id="update_desc_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
