...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from tour_city_names where id='$tour_city_id'"));
?>
...
<div class="modal fade" id="tour_city_update_modal"  role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body text-center">
        ...
        <div class="row mg_bt_10">
          <div class="col-md-12">
            ...
            <?php $sq_city_info = mysqli_fetch_assoc(mysqlQuery("select * from city_master where city_id='$sq[city_id]'")); ?>
              <option value="<?php echo $sq_city_info['city_id'] ?>"><?php echo $sq_city_info['city_name'] ?></option>
              <?php 
              $sq1 = mysqlQuery("select * from city_master");
