...
<div class="app_panel_content Filter-panel">
      ...
      <div class="row">
          ...
          <table id="package_program_list" name="package_program_list" class="table mg_bt_0 table-bordered">
              ...
              <td class="col-md-3"><input type="text" id="special_attaraction" onchange="validate_spattration(this.id);" name="special_attaraction" class="form-control mg_bt_10" placeholder="Special Attraction" title="Special Attraction"></td>
              <td class="col-md-5"><textarea id="day_program" name="day_program" class="form-control mg_bt_10" title="" rows="3" placeholder="*Day-wise Program" onchange="validate_dayprogram(this.id);" title="Day-wise Program"></textarea></td>
              <td class="col-md-2"><input type="text" id="overnight_stay" name="overnight_stay" onchange="validate_onstay(this.id);" class="form-control mg_bt_10" placeholder="Overnight Stay" title="Overnight Stay"></td>
