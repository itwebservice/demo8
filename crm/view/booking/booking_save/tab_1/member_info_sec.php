...
<tr>
    ...
    <td><select id="cmb_m_honorific1" title="Honorific" name="cmb_m_honorific1" data-toggle="tooltip" onchange="changeGender(this.id);">
    ...
    <td><input style="width: 129px;" type="text" id="txt_m_first_name1" title="First Name" name="txt_m_first_name1" onchange="fname_validate(this.id); payment_details_reflected_data('tbl_member_dynamic_row');" placeholder="*First Name" />
    </td>

    <td><input style="width: 129px;" type="text" id="txt_m_middle_name1" title="Middle Name" name="txt_m_middle_name1" onchange=" fname_validate(this.id); payment_details_reflected_data('tbl_member_dynamic_row');" placeholder="Middle Name" />
    </td>

    <td><input style="width: 129px;" type="text" id="txt_m_last_name1" title="Last Name" name="txt_m_last_name1" onchange="fname_validate(this.id);payment_details_reflected_data('tbl_member_dynamic_row');" placeholder="Last Name" />
    </td>
    ...
    <td><input type="text" style="width: 100px;" id="m_birthdate1" name="m_birthdate1" title="Birthdate" onchange="calculate_age_member(this.id); payment_details_reflected_data('tbl_member_dynamic_row');" value="<?= date('d-m-Y',  strtotime(' -1 day'))?>" placeholder="*Birth Date" class="form-control" />
    </td>

    <td><input type="text" id="txt_m_age1" name="txt_m_age1" style="width: 100px;" title="Age(Y:M:D)" placeholder="*Age" onchange="payment_details_reflected_data('tbl_member_dynamic_row')" />
    </td>
    ...
    <td><input type="text" style="width: 139px;text-transform: uppercase;" id="txt_m_passport_no" name="txt_m_passport_no" placeholder="Passport No" title="Passport No" onchange="validate_passport(this.id);payment_details_reflected_data('tbl_member_dynamic_row')" disabled></td>
        ...
        success:function(result){
           ...
           var table = document.getElementById("tbl_member_dynamic_row");            
            ...
            for(var i=0; i<pass_arr.length; i++){
                ...
                if($('#tour_type_r').val() == "International"){
