        ...
        <div class="app_panel_content Filter-panel">
          <div class="row">
              ...
              <div class="col-sm-4 mg_bt_10_sm_xs">
                  <select class="form-control" style="width:100%" id="cmb_tour_name" name="cmb_tour_name" title="Tour Name" onchange="tour_group_reflect(this.id, false); payment_details_reflected_data('tbl_member_dynamic_row');  seats_availability_reflect(); tour_type_reflect(this.id); " title="Tour Name"> 
