 ...
 <div class="row mg_tp_20"> <div class="col-xs-12"> <div class="table-responsive">       
    ...
    <table id="tbl_plane_travel_details_dynamic_row" name="tbl_plane_travel_details_dynamic_row" class="table table-bordered table-hover pd_bt_51 no-marg">
        <tr>
            ...
            <td><input type="text" id="txt_arravl-1" name="txt_arravl-1" class="app_datetimepicker" placeholder="Arrival Date & Time" title="Arrival Date & Time" onchange="validate_validDatetime('txt_plane_date-1',this.id)" value="<?= date('d-m-Y') ?>" style="width:136px"></td>
