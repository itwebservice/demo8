<div class="row mg_bt_30"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    <table id="tbl_package_hotel_master" name="tbl_package_hotel_master" class="table table-bordered table-hover mg_bt_30 no-marg-sm">
    <tr>
					...
					<td><input type="text" id="hotel_tota_days1"  name="hotel_tota_days1" placeholder="*Total Night(s)" class="form-control" title="Total Night(s)" readonly></td></td>
                </tr> 
    </table>
