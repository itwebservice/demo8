                ...
                <div class="panel panel-default panel-body main_block bg_light mg_bt_30">
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                            ...
                            <input type="text" id="txt_adult_seats" name="txt_adult_seats" value="0" class="text-center form-control valid" title="Total Adult(s)" readonly />            
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                            <label>Total Child(ren) With Bed</label>
                            <input type="text" id="txt_child_b_seats" name="txt_child_b_seats" value="0" class="text-center form-control valid" title="Total Child(ren) With Bed" readonly/>           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                            <label>Total Child(ren) Without Bed</label>
                            <input type="text" id="txt_child_wb_seats" name="txt_child_wb_seats" value="0" class="text-center form-control valid" title="Total Child(ren) Without Bed" readonly/>           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                            <label>Total Infant(s)</label>
                            <input type="text" id="txt_infant_seats" name="txt_infant_seats" value="0" class="text-center form-control valid" title="Total Infant(s)" readonly />            
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center hidden">
                            <label>Total Passenger(s)</label>
                            <input type="text" id="txt_total_seats" name="txt_total_seats" value="0" class="text-center form-control valid" title="Total Passenger(s)" readonly />            
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            ...
                            <input type="text" id="txt_child_bed_expense" title="Child With Bed Cost" placeholder="Child With Bed" name="txt_child_bed_expense" class="text-right form-control valid" onchange="tour_cost_calculate(this.id);validate_balance(this.id)"  />           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            <label>Child Without Bed Cost</label>
                            <input type="text" id="txt_child_wbed_expense" title="Child Without Bed Cost" placeholder="Child Without Bed" name="txt_child_wbed_expense" class="text-right form-control valid" onchange="tour_cost_calculate(this.id);validate_balance(this.id)"  />           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            ...
                            <select name="gcurrency_code" id="gcurrency_code" title="Currency" style="width:100%" data-toggle="tooltip" required>
                                <?php
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        <div class="text-right text_center_xs mg_tp_10">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_repeater_discount" name="txt_repeater_discount" class="text-right" placeholder="Repeaters Travelling Discount" title="Repeaters Travelling Discount" onchange="validate_balance(this.id);calculate_total_discount(this.id);" value="0"  />
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label>Adjustment discount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_adjustment_discount" name="txt_adjustment_discount" class="text-right" placeholder="Adjustment Discount" title="Adjustment Discount"  value="0"  onchange="validate_balance(this.id);calculate_total_discount(this.id);"/>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label class="theme_col">Total Discount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">                              
                                <input type="text" id="txt_total_discount" name="txt_total_discount" class="text-right amount_feild_highlight" placeholder="Total Discount" title="Total Discount " onchange="get_auto_values('txt_date','basic_amount','cmb_payment_mode1','service_charge','markup','save','false','txt_total_discount','discount',false);" readonly />
                        ...
                        <div class="text-right text_center_xs">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">     
                                <input type="text" id="basic_amount" name="basic_amount" class="text-right" value="0" title= "Basic Amount" onchange="get_auto_values('txt_date','basic_amount','cmb_payment_mode1','service_charge','markup','save','false','basic','basic')" readonly />
                        ...
                        <div class="text-right text_center_xs">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="number" id="tcs_tax" name="tcs_tax" class="text-right" placeholder="TCS" title="TCS" onchange="tour_cost_calculate(this.id);validate_balance(this.id)" <?= $tcs_readonly ?>/>
                            </div>
                        ...
                        <div class="text-right text_center_xs">
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_tp_10 mg_bt_10"><label class="theme_col">Total Amount</label></div>
                        ...
                        <div class="col-xs-12 mg_bt_30">
                            <div class="panel panel-default panel-body pad_8 mg_bt_10 mg_tp_10 legend_pan bk_payment_wrap">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                        <select id="cmb_payment_mode1" title="Mode"  name="cmb_payment_mode1" onchange="payment_installment_enable_disable_fields('1');get_auto_values('txt_date','basic_amount','cmb_payment_mode1','service_charge','markup','save','false','service_charge','discount',false);get_identifier_block('identifier','cmb_payment_mode1','credit_card_details','credit_charges');get_credit_card_charges('identifier','cmb_payment_mode1','txt_amount1','credit_card_details','credit_charges')">
                        ...
                        <div class="col-xs-12 hidden">
                            <div class="panel panel-default panel-body pad_8 mg_bt_0 legend_pan bk_payment_wrap" style="margin-top: 30px;">
                                <!-- <div class="row"> 
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                        <select id="cmb_payment_mode2" title="Mode" name="cmb_payment_mode2" onchange="payment_installment_enable_disable_fields('2');get_auto_values('txt_date','basic_amount','cmb_payment_mode2','service_charge','markup','save','false','service_charge','discount',false);">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row text-center mg_bt_30">                                
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12 text_center_xs mg_bt_30">
                                    <input type="text" id="txt_date" name="txt_date" placeholder="Booking Date" title="Booking Date" value="<?php echo date('d-m-Y H:i') ?>" onchange="check_valid_date(this.id);check_valid_date(this.id);get_auto_values('txt_date','basic_amount','cmb_payment_mode1','service_charge','markup','save','false','service_charge','discount',false);"/>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="panel panel-default panel-body pad_8 text-center main_block bg_light mg_bt_0 mg_tp_30">
