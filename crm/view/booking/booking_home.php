...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from branch_assign where link='booking/index.php'"));
...
<div class="app_panel_content Filter-panel">
  <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
        <select class="form-control" id="group_id_filter" name="group_id_filter" onchange="traveler_member_reflect();" title="Tour Date"> 
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
          <input type="text" id="to_date_filter" name="to_date_filter" onchange="validate_validDate('from_date_filter','to_date_filter');" placeholder="To Date" title="To Date">
      </div>
...
function list_reflect()
{
  ...
  var branch_status = $('#branch_status').val();
	...
	$.post('list_reflect.php', { tour_id : tour_id, group_id : group_id, customer_id : customer_id, booking_id : booking_id, from_date : from_date, to_date : to_date , cust_type : cust_type, company_name : company_name, branch_status : branch_status}, function(data){
		//$('#div_list').html(data);
    pagination_load(data,columns, true,true, 20, 'gtour_table');
    $('.loader').remove();
	});
}
