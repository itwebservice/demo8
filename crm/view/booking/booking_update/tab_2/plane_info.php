...
<tr>
    ...
    <td><input type="text" id="<?php echo 'txt_arravl'.$count_p.'p' ?>" name="<?php echo 'txt_arravl-'.$count_p.'p' ?>" placeholder="Arrival date & time" title="Arrival date & time" class="app_datetimepicker" value="<?php echo date("d-m-Y H:i", strtotime($row_plane_details['arraval_time'])) ?>" style="width:136" onchange="validate_travelingDates(this.id);"/></td>
