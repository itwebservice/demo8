...
$type = $_POST['type'];
$sq_entry = mysqli_fetch_assoc(mysqlQuery("select * from modulewise_video_master where entry_id='$entry_id'"));
$video_url = $sq_entry['video_url'];
?>
<div class="modal fade guidlines_modal" id="mydescp" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
