...
function get_checkoutpage(){
    ...
    $.post(base_url + 'Tours_B2B/checkout_pages/get_checkoutpage.php', { cart_list_arr1 : cart_list_arr,payment_amount:payment_amount ,global_currency:global_currency, timing_slots:timing_slots}, function (data) {
