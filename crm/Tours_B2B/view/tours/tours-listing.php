      ...
      <!-- ***** Tours Listing ***** -->
        ...
        while(($row_query  = mysqli_fetch_assoc($sq_query))){
            ...
            while($row_tariff = mysqli_fetch_assoc($sq_tariff)){
              ...
              $total_cost1 = ($adult_count*floatval($row_tariff['badult'])) + ($child_wocount*floatval($row_tariff['bcwob'])) + ($child_wicount*floatval($row_tariff['bcwb'])) + ($extra_bed*floatval($row_tariff['bextra'])) + ($infant_count*floatval($row_tariff['binfant']));
