...
$final_result = (sizeof($hotel_results_array) === 0) ? 0 : json_encode($hotel_results_array,JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
?>
<input type='hidden' value='<?= $final_result ?>' id='hotel_results' name='hotel_results'/>
