...
$final_result = (sizeof($activity_result_array) === 0) ? 0 : json_encode($activity_result_array,JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
?>
<input type='hidden' value='<?= $final_result ?>' id='activity_results' name='activity_results'/>
...
$(document).ready(function () {
    ...
    if(parseInt(activity_results) != 0){
