...
public function refund_estimate_update()
{
  ...
  $sq_refund = mysqlQuery("update miscellaneous_master set cancel_amount='$cancel_amount', total_refund_amount='$total_refund_amount',cancel_flag='1' where misc_id='$misc_id'");
  if($sq_refund)
  {
  	//Finance save
