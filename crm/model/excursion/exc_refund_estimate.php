...
public function refund_estimate_update()
{
  ...
  $sq_refund = mysqlQuery("update excursion_master set cancel_amount='$cancel_amount', total_refund_amount='$total_refund_amount',cancel_flag='1'  where exc_id='$exc_id'");
  if($sq_refund){
