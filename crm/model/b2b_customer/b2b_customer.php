   ...
   function b2b_profile_save(){
    ...
    function quotation_save(){
        ...
        if($timestamp_count>0){
            ...
            $sq_insert = mysqlQuery("INSERT INTO `b2b_quotations`(`quotation_id`,`register_id`,`pdf_data_array`,`cart_list_arr`,`created_at`,`unique_timestamp`,`currency`)values('$quotation_id','$register_id','$pdf_data_array','$cart_list_arr','$created_at','$unique_timestamp','$quotation_currency')");
        }
    }
