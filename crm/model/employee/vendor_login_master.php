...

{
	...
	$sq_login = mysqlQuery("insert into vendor_login (login_id, username, password, vendor_type, user_id, active_flag, email) values ('$login_id', '$username', '$password', '$vendor_type', '$user_id', '$active_flag', '$email_id')");
...

{
	...
	$sq_vendor = mysqli_num_rows(mysqlQuery("SELECT * from vendor_login where username='$username' and password='$password' and vendor_type='$vendor_type' and login_id!='$login_id'"));
