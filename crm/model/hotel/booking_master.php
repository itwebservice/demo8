...
class booking_master{
  ...
  public function booking_save(){
    ...
    $timestamp_count = mysqli_num_rows(mysqlQuery("select * from hotel_booking_master where unique_timestamp='$unique_timestamp'"));
...
public function finance_update($sq_booking_info, $row_spec,$particular){
  ...
  $sq_hotel = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as payment_amount from hotel_booking_payment where booking_id='$booking_id'"));
