...
public function refund_estimate_update()
{
  ...
  $sq_refund = mysqlQuery("update hotel_booking_master set cancel_amount='$cancel_amount', refund_total_fee='$total_refund_amount' ,cancel_flag='1' where booking_id='$booking_id'");
