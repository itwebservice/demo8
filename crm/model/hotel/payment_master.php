  ...
  if($payment_mode == 'Cash') {  $pay_gl = 20; }
    ...
    if($payment_mode != 'Credit Note'){
      if($payment_mode == 'Credit Card'){
        ...
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $credit_charges, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
    ...
    $finance_charges = number_format($finance_charges,2);
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = 231;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $credit_company_amount, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $company_gl;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date1, $payment_amount1, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $pay_gl;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
...
public function bank_cash_book_save($payment_id, $branch_admin_id)
{
  ...
  $bank_id = $bank_id; 
  $particular = get_sales_paid_particular(get_hotel_booking_payment_id($payment_id,$yr1), $payment_date, $payment_amount, $sq_hotel_booking_info['customer_id'], $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id);
  $clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
  $payment_side = "Debit";
  ...
  if($payment_amount1 != $payment_old_value){
    if($payment_mode != 'Credit Note'){
		...
		if($payment_mode == 'Credit Card'){
			...
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $credit_charges_old, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $cust_gl;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
...
$finance_charges = number_format($finance_charges,2);
			...
			$payment_amount = $finance_charges;
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = 231;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
			...
			$payment_amount = $credit_company_amount;
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $credit_company_amount, $customer_id, $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $company_gl;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
			...
			$payment_date = $payment_date1;
			$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date, $payment_old_value, $sq_hotel_info['customer_id'], $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = $pay_gl;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
		...
		$payment_amount = $payment_old_value;
		$payment_date = $payment_date1;
		$payment_particular = get_sales_paid_particular(get_hotel_booking_payment_id($booking_id,$yr1), $payment_date1, $payment_old_value, $sq_hotel_info['customer_id'], $payment_mode, get_hotel_booking_id($booking_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = $cust_gl;
		$payment_side = "Debit";
		$clearance_status = "";
...
$total_pay_amt = $sq_total_amount['sum'] + $credit_card_amount;
  ...
  global $model;
  $model->generic_payment_mail('50',$payment_amount, $payment_mode, $total_amount, $total_pay_amt, $payment_date, $due_date,$email_id, $subject,$customer_name,$sq_hotel_info['currency_code']);
}
...
public function whatsapp_send(){
  ...
  global $encrypt_decrypt,$secret_key,$currency;
  $sq_hotel_info = mysqli_fetch_assoc(mysqlQuery("select * from hotel_booking_master where booking_id=".$_POST['booking_id']));

  $sq_pay = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sum, sum(credit_charges) as sumc from hotel_booking_payment where clearance_status!='Cancelled' and booking_id=".$_POST['booking_id']));
