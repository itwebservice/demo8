...
public function cancel_traveler_booking($tourwise_id, $traveler_id_arr, $first_names_arr)
{
  ...
  if($GLOBALS['flag']){
    ...
    echo "Group booking has been successfully cancelled.";
    exit;
  }
  else{
    rollback_t();
...
public function refund_mail_send($tourwise_id,$total_refund,$refund_date,$refund_mode){
  ...
  <tr>
      <table width="85%" cellspacing="0" cellpadding="5" style="color: #888888;border: 1px solid #888888;margin: 0px auto;margin-top:20px; min-width: 100%;" role="presentation">
          <tr><td style="text-align:left;border: 1px solid #888888;">Service Name</td>   <td style="text-align:left;border: 1px solid #888888;">Group Tour</td></tr>
          ...
          <tr><td style="text-align:left;border: 1px solid #888888;">Pending Refund</td>   <td style="text-align:left;border: 1px solid #888888;">'.$currency_logo.' '.number_format($remaining,2).'</td></tr>
