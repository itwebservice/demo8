...

{
    ...
    $sq_est = mysqlQuery("insert into refund_traveler_estimate(estimate_id, tourwise_traveler_id, cancel_amount, total_refund_amount, created_at) values ('$estimate_id', '$tourwise_id','$cancel_amount', '$total_refund_amount', '$created_at')");       
