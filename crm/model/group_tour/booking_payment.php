...
if($payment_mode != 'Credit Note'){
  if($payment_mode == 'Credit Card'){
    ...
    $payment_particular = get_sales_paid_particular(get_group_booking_payment_id($payment_id,$yr1), $payment_date, $credit_charges, $customer_id, $payment_mode, get_group_booking_id($tourwise_traveler_id,$yr1),$bank_id1,$transaction_id1);
    ...
    $payment_date = $payment_date;
    $payment_particular = get_sales_paid_particular(get_group_booking_payment_id($payment_id,$yr1), $payment_date, $finance_charges, $customer_id, $payment_mode, get_group_booking_id($tourwise_traveler_id,$yr1),$bank_id1,$transaction_id1);
    $ledger_particular = get_ledger_particular('By','Cash/Bank');
    $gl_id = 231;
    $payment_side = "Debit";
    $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
    ...
    $payment_date = $payment_date;
    $payment_particular = get_sales_paid_particular(get_group_booking_payment_id($payment_id,$yr1), $payment_date, $credit_company_amount, $customer_id, $payment_mode, get_group_booking_id($tourwise_traveler_id,$yr1),$bank_id1,$transaction_id1);
    $ledger_particular = get_ledger_particular('By','Cash/Bank');
    $gl_id = $company_gl;
    $payment_side = "Debit";
    $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
...
function finance_update($sq_payment_info, $clearance_status1)
{
    ...
    if($payment_amount1 != $payment_old_value){
      ...
      if($payment_mode == 'Credit Card'){
        ...
        $payment_date = $payment_date;
        $payment_particular = get_sales_paid_particular(get_group_booking_payment_id($payment_id,$yr1), $payment_date, $credit_charges_old, $customer_id, $payment_mode, get_group_booking_id($tourwise_traveler_id,$yr1),$bank_id,$transaction_id1);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $cust_gl;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_amount = $finance_charges;
        $payment_date = $payment_date;
        $payment_particular = get_sales_paid_particular(get_group_booking_payment_id($payment_id,$yr1), $payment_date, $finance_charges, $customer_id, $payment_mode, get_group_booking_id($tourwise_traveler_id,$yr1),$bank_id,$transaction_id1);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = 231;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_amount = $credit_company_amount;
        $payment_date = $payment_date;
        $payment_particular = get_sales_paid_particular(get_group_booking_payment_id($payment_id,$yr1), $payment_date, $credit_company_amount, $customer_id, $payment_mode, get_group_booking_id($tourwise_traveler_id,$yr1),$bank_id,$transaction_id1);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $company_gl;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date;
        $payment_particular = get_sales_paid_particular(get_group_booking_payment_id($payment_id,$yr1), $payment_date, $payment_old_value, $customer_id, $payment_mode, get_group_booking_id($tourwise_traveler_id,$yr1),$bank_id,$transaction_id1);
        $ledger_particular = get_ledger_particular('By','Cash/Bank');
        $gl_id = $pay_gl;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
...
//////////////////////////////////**Payment notification message send start**/////////////////////////////////////
 ...
 public function payment_email_notification_send($tourwise_traveler_id, $payment_amount, $payment_mode, $payment_date, $payment_id)
 {
   ...
   $sq_tourwise = mysqli_fetch_assoc(mysqlQuery("select total_travel_expense, customer_id, net_total,form_date,currency_code from tourwise_traveler_details where id='$tourwise_traveler_id'"));
   ...
   global $model;
    $model->generic_payment_mail('44',$payment_amount, $payment_mode, $total_amount, $paid_amount, $payment_date,$due_date, $email_id,$subject,$customer_name,$sq_tourwise['currency_code']);
 }
...
//////////////////////////////////** Advance Payment email notification send start**/////////////////////////////////////
 ...
 public function whatsapp_send(){
	global $app_contact_no,$session_emp_id,$currency_logo,$currency,$encrypt_decrypt, $secret_key;
  $booking_id = $_POST['booking_id'];
  $payment_amount = $_POST['payment_amount'];
  $sq_tourwise = mysqli_fetch_assoc(mysqlQuery("select total_travel_expense, customer_id, net_total,currency_code from tourwise_traveler_details where id='$booking_id'"));
