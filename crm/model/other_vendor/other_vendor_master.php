...
public function save_vendor()
{
    ...
    $sq_vendor_count = mysqli_num_rows(mysqlQuery("select * from other_vendors where vendor_name='$vendor_name'"));
    ...
    $sq_max = mysqli_fetch_assoc(mysqlQuery("select max(vendor_id) as max from other_vendors"));
...
public function update_vendor()
{
    ...
    $sq_vendor_count = mysqli_num_rows(mysqlQuery("select * from other_vendors where vendor_name='$vendor_name' and vendor_id!='$vendor_id'"));
    if($sq_vendor_count>0){
