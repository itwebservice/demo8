...
public function refund_mail_send($ticket_id,$refund_amount,$refund_date,$refund_mode,$transaction_id){
	...
	global $encrypt_decrypt,$secret_key,$currency_logo;
	...
	$sq_pend_pay=mysqli_fetch_assoc(mysqlQuery("select sum(refund_amount) as sum from ticket_refund_master where ticket_id='$ticket_id' and clearance_status='Pending'"));
	...
	<table width="85%" cellspacing="0" cellpadding="5" style="color: #888888;border: 1px solid #888888;margin: 0px auto;margin-top:20px; min-width: 100%;" role="presentation">
		...
		<tr><td style="text-align:left;border: 1px solid #888888;">Paid Amount</td>   <td style="text-align:left;border: 1px solid #888888;" >'.$currency_logo.' '.number_format($paid_amt,2).'</td></tr>
