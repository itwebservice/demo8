...

{
  ...
  $sq_refund = mysqlQuery("update train_ticket_master set cancel_amount='$cancel_amount', refund_net_total='$total_refund_amount',cancel_flag='1' where train_ticket_id='$train_ticket_id'");
