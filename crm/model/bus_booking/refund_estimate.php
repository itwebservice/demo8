...
public function refund_estimate_save(){
  ...
  $total_refund_amount = $_POST['total_refund_amount'];
	...
	begin_t();
	$sq_est = mysqlQuery("update bus_booking_master set cancel_amount='$cancel_amount', refund_net_total='$total_refund_amount',cancel_flag='1' where booking_id='$booking_id'");
	if(!$sq_est){
		$GLOBALS['flag'] = false;
