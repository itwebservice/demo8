      ...
      <div class="row">
        ...
        <div class="col-md-6 col-xs-12">
          ...
          <ul class="pack_info">
            ...
            <li><span>Destination Name </span>:  <?= $sq_quotation['tour_name']; ?> </li>
        ...
        <div class="col-md-12">
          ...
          <div class="adolence_info mg_tp_25">
            ...
            <ul class="main_block">
              ...
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_sm_xs"><span>Child With Bed : </span><?= $sq_quotation['children_with_bed']; ?></li>

              <li class="col-md-2 col-sm-4 col-xs-12"><span>Child Without Bed : </span><?= $sq_quotation['children_without_bed']; ?></li>
          ...
          <div class="adolence_info">
            ...
            <ul class="main_block">
              ...
              <div class="row">
                ...
                ?>
                <?php if($sq_quotation['adult_cost']!='0'){?><li class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_sm_xs"><span>Adult Cost : </span><?= $adult_cost1 ?></li> <?php } ?>
              
                <?php if($sq_quotation['infant_cost']!='0'){?><li class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_sm_xs"><span>Infant Cost : </span><?= $infant_cost1 ?></li> <?php } ?>
                <?php if($sq_quotation['with_bed_cost']!='0'){?><li class="col-md-3 col-sm-6 col-xs-12"><span>Child with Bed Cost : </span><?= $with_bed_cost1 ?></li> <?php } ?>
                <?php if($sq_quotation['children_cost']!='0'){?><li class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_sm_xs"><span>Child w/o Bed Cost : </span><?= $children_cost1 ?></li> <?php } ?>
                <li class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_sm_xs"><span>Other Charges : </span><?= $service_charge ?></li>             
                <li class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 sm_r_brd_r8"><span>Tax : </span><?= $service_tax_amount_show ?></li>
                <li class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs sm_r_brd_r8 highlight" style="font-weight: 600; color: #016d01;"><span class="highlight">Quotation Cost : </span><?= $quotation_cost1 ?></li>
              </div>
