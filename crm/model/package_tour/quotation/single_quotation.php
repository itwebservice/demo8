        ...
        <div class="col-md-12">
          ...
          <div class="adolence_info">
            ...
            if($sq_quotation['costing_type'] == 1){
              ...
              while($sq_costing = mysqli_fetch_assoc($sq_costing1)){
                ...
                ?>
                  <div class="row mg_bt_10">
                    ...
                    <li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs  highlight" style="font-weight: 600; color: #016d01;"><span class="highlight">Quotation Cost : </span><?= $currency_amount1 ?></li>
                    </ul>
                  </div>
                <?php
              }
              ...
              <div class="row mg_bt_10">
                <ul class="main_block">
                  <li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_sm_xs"><span>Package Type : </span><u><?= $sq_costing['package_type'].' ('.$currency_amount1.')' ?></u></li>
                  <?php if($adult_cost!='0'){?><li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_sm_xs"><span>Adult Cost : </span><?= $adult_cost ?></li> <?php } ?>
