...
<!-- Modal feedback_suggestion-->
  <div class="modal fade acco_hotel_slider_moal" id="acco_hotel_slider"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-body">
           ...
           <?php 
           $sq_hotel_count = mysqli_num_rows(mysqlQuery("select * from hotel_vendor_images_entries where hotel_id = '$hotel_name'"));
            if($sq_hotel_count == '0'){
           ...
           $sq_hotel_image = mysqlQuery("select * from hotel_vendor_images_entries where hotel_id = '$hotel_name'");
