...
function app_format_save(){
	...
	if($sq_app_setting_count == '0'){
		...
		$sq_invoice = mysqlQuery("update app_settings set quot_format='$quot_format',quot_img_url='$image' where setting_id='1'");
	}
	...
	if($sq_invoice){
		...
		echo "error--Sorry, Format Company profile details are not saved!";
	}
