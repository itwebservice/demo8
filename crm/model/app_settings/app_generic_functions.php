...
function currency_conversion($from_currency,$to_currency,$quotation_cost){
  ...
  if($to_currency!='0' && $from_currency != $to_currency){
...
function tax_reflection_update($serivcename,$service_tax_subtotal,$taxation_type,$visa_id1,$visa_id,$booking_date, $customer_id, $row_spec,$branch_admin_id)
{
  ...
  $sq_count_c = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='21' and payment_side='Credit'"));
  $sq_count_s = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='119' and payment_side='Credit'"));
  $sq_count_i = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='67' and payment_side='Credit'"));
  $sq_count_u = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='138' and payment_side='Credit'"));
  $sq_count_v = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='150' and payment_side='Credit'"));
...
function purchase_tax_reflection_update($serivcename,$service_tax_subtotal,$taxation_type,$visa_id1,$visa_id,$booking_date,$payment_mode, $row_spec,$branch_admin_id)
{
  ...
  $sq_count_c = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='145' and payment_side='Debit'"));
  $sq_count_s = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='146' and payment_side='Debit'"));
  $sq_count_i = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='148' and payment_side='Debit'"));
  $sq_count_u = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='147' and payment_side='Debit'"));
  $sq_count_v = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='149' and payment_side='Debit'"));
...
function tax_cancel_reflection_update($serivcename,$service_tax_subtotal,$taxation_type,$visa_id1,$visa_id,$booking_date, $customer_id, $row_spec,$branch_admin_id)
{
  ...
  $sq_count_c = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='156' and payment_side='Debit'"));
  $sq_count_s = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='154' and payment_side='Debit'"));
  $sq_count_i = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='152' and payment_side='Debit'"));
  $sq_count_u = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='158' and payment_side='Debit'"));
  $sq_count_v = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='159' and payment_side='Debit'"));
...
function purchase_tax_cancel_reflection_update($serivcename,$service_tax_subtotal,$taxation_type,$visa_id1,$visa_id,$booking_date,$payment_mode, $row_spec,$branch_admin_id)
{
  ...
  $sq_count_c = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='155' and payment_side='Credit'"));
  $sq_count_s = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='153' and payment_side='Credit'"));
  $sq_count_i = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='151' and payment_side='Credit'"));
  $sq_count_u = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='157' and payment_side='Credit'"));
  $sq_count_v = mysqli_num_rows(mysqlQuery("select * from finance_transaction_master where module_name='$serivcename' and module_entry_id='$visa_id1' and gl_id ='160' and payment_side='Credit'"));
...
function get_customer_name($booking_type,$booking_id)
{
  ...
  if($booking_type == "Visa Booking"){
    ...
    $sq_booking = mysqli_fetch_assoc(mysqlQuery("select * from passport_master where passport_id='$booking_id'"));
    $customer_id = $sq_booking['customer_id'];
  }
    ...
    $sq_booking = mysqli_fetch_assoc(mysqlQuery("select * from forex_booking_master where booking_id='$booking_id'"));
    $customer_id = $sq_booking['customer_id'];
  }
    ...
    $sq_booking = mysqli_fetch_assoc(mysqlQuery("select * from b2c_sale where booking_id='$booking_id'"));
    $customer_id = $sq_booking['customer_id'];
  }
  else if($booking_type == "B2B Booking"){
    $sq_booking = mysqli_fetch_assoc(mysqlQuery("select * from b2b_sale where passport_id='$booking_id'"));
    $customer_id = $sq_booking['customer_id'];
  }
  else {
