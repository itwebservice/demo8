      ...
      <div class="row mg_tp_30">
        <div class="col-md-12">
          ...
          <?php }else{ ?>
            ...
            <li class="col-md-4 mg_tp_10 mg_bt_10"><span>TRAVELLING DATE : </span><?= get_datetime_user($sq_quotation['traveling_date']) ?></li>
          <?php } ?>
    ...
    <section class="print_sec main_block side_pad mg_tp_30">
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="print_info_block">
            <ul class="main_block">
              <li class="col-md-12 mg_tp_10 mg_bt_10"><span>TOTAL FARE : </span><?= number_format($newBasic,2) ?></li>
