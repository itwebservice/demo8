...
$sq_fields = mysqli_fetch_assoc(mysqlQuery("SELECT * FROM `forex_booking_master` WHERE `booking_id` = ".$booking_id));
      ...
      <div class="col-md-12">
       <div class="table-responsive">
        <table class="table table-bordered no-marg" id="tbl_emp_list" style="padding: 0 !important;">
          ...
          <?php 
          $count = 1;
          $sq_vehicle_entries = mysqlQuery("select * from forex_booking_master where booking_id='$booking_id'");
