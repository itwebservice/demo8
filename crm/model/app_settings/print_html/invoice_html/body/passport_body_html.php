...
$total_paid += $charge;
$bsmValues = mysqli_fetch_assoc(mysqlQuery("select bsm_values from passport_master where passport_id = '$passport_id'"));
      ...
      <div class="col-md-12">
       <div class="table-responsive">
        <table class="table table-bordered no-marg" id="tbl_emp_list" style="padding: 0 !important;">
          ...
          <?php 
          $count = 1;
          $sq_passenger = mysqlQuery("select * from passport_master_entries where passport_id = '$passport_id'");
