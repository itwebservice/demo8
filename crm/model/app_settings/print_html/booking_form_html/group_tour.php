    ...
    <section class="print_sec main_block">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          $basic_amount = currency_conversion($currency,$tourwise_details['currency_code'],($newBasic + $train_expense + $total_plane_expense + $total_cruise_expense));
          $train_expense = currency_conversion($currency,$tourwise_details['currency_code'],$tourwise_details['total_train_expense']);
          $total_discount = currency_conversion($currency,$tourwise_details['currency_code'],$total_discount);
          $total_cruise_expense = currency_conversion($currency,$tourwise_details['currency_code'],$tourwise_details['total_cruise_expense']);
          $total_plane_expense = currency_conversion($currency,$tourwise_details['currency_code'],$tourwise_details['total_plane_expense']);
          ...
          <div class="print_amount_block">
            ...
            <ul class="main_block no-pad text-right noType">
              <li class="col-md-6 mg_tp_10 mg_bt_10"><div style="float:left"><b>TAX AMOUNT : </b></div><?php echo str_replace(',','',$name).$service_tax_amount_show; ?></li>
