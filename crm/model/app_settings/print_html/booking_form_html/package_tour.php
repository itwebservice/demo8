...
?>
  ...
  {?>
    ...
    $newBasic1 = currency_conversion($currency,$package_booking_info['currency_code'],($total_hotel_expense+$total_travel_expense+$newSC));
    ...
    <section class="print_sec main_block">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="print_amount_block">
            ...
            <ul class="main_block no-pad text-right noType">
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>TAX : </span><?php echo str_replace(',','',$name).$service_tax_amount_show; ?></li>
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>CREDIT CARD CHARGES : </span><?= $charge1 ?></li>
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>TCS<?='('.$package_booking_info['tcs_per'].'%)'?> : </span><?= $tcs_tax ?></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="print_amount_block">
            <ul class="main_block no-pad text-right noType">
              <li class="col-md-12 mg_tp_10 mg_bt_10 font_5"><span>TOTAL AMOUNT : </span><?php echo $net_amount1; ?></li>
            </ul>
          </div>
        </div>
      </div>
