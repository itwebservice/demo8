...
class refund_estimate{
  ...
  public function refund_estimate_update(){
    ...
    begin_t();
    $sq_refund = mysqlQuery("update car_rental_booking set cancel_amount='$cancel_amount', total_refund_amount='$total_refund_amount',cancel_flag='1' where booking_id='$booking_id'");
    if($sq_refund){
      //Finance save
