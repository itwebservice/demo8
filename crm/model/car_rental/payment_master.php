...
class payment_master
{
  ...
  public function finance_save($payment_id, $branch_admin_id)
  {
    ...
    if ($payment_mode != 'Credit Note') {
      ...
      if ($payment_mode == 'Credit Card') {
        ...
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date, $credit_charges, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1);
        ...
        $payment_amount = $credit_charges;
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date1, $credit_charges, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = 224;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == "Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = 231;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == "Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date, $credit_company_amount, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = $company_gl;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == "Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date, $payment_amount1, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = $pay_gl;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
  ...
  public function finance_update($sq_payment_info, $clearance_status1)
  {
    ...
    if ($payment_amount1 != $payment_old_value) {
      ...
      if ($payment_mode == 'Credit Card') {
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date, $credit_charges_old, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1, $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = $cust_gl;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == "Credit Card") ? "Pending" : "";
        ...
        $payment_amount = $credit_charges_old;
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date1, $credit_charges_old, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1, $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = 224;
        $payment_side = "Debit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == "Credit Card") ? "Pending" : "";
        ...
        $payment_amount = $finance_charges;
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1, $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = 231;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == "Credit Card") ? "Pending" : "";
        ...
        $payment_amount = $credit_company_amount;
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date, $credit_company_amount, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1, $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = $company_gl;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == "Credit Card") ? "Pending" : "";
        ...
        $payment_date = $payment_date1;
        $payment_particular = get_sales_paid_particular(get_car_rental_booking_payment_id($booking_id, $yr1), $payment_date, $payment_old_value, $customer_id, $payment_mode, get_car_rental_booking_id($booking_id, $yr1), $bank_id1, $transaction_id1, $bank_id1, $transaction_id1);
        $ledger_particular = get_ledger_particular('By', 'Cash/Bank');
        $gl_id = $pay_gl;
        $payment_side = "Credit";
        $clearance_status = ($payment_mode == "Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
  ...
  public function payment_email_notification_send($booking_id, $payment_amount, $payment_mode, $payment_date)
  {
    ...
    global $model;
    $model->generic_payment_mail('46', $payment_amount, $payment_mode, $total_amount, $total_pay_amt, $payment_date, $due_date, $email_id, $subject, $customer_name);
  }
