...
public function monthly_offer_send_mail($template_id,$group_id)
{
	...
	$sq_email_group = mysqlQuery("select * from email_group_entries where email_group_id = '$group_id'");
	while($row_email_group = mysqli_fetch_assoc($sq_email_group))
	{
		$email_id = $row_email_group['email_id_id'];
	 	$sq_email = mysqlQuery("select * from sms_email_id where email_id_id = '$email_id'");

		while($row_email=mysqli_fetch_assoc($sq_email)){

			$sq_template = mysqli_fetch_assoc(mysqlQuery("select * from email_template_master where template_id = '$template_id'"));
...
////////////////////////////////////// Easter //////////////////////////////////	
	public function easter_send_mail($template_id,$group_id)
	{
		global $app_email_id, $app_name, $app_contact_no, $admin_logo_url, $app_website;	 	
	 	...
	 	{
		$email_id = $row_email_group['email_id_id'];
	 		$sq_email = mysqli_fetch_assoc(mysqlQuery("select * from sms_email_id where email_id_id = '$email_id'"));
