<?php 
 ...
 include_once('../model.php');
	...
	$enquirty_count = mysqli_num_rows(mysqlQuery("select * from enquiry_master  where status!='Disabled'"));

	$followup_count = 0;

	$content1 = '';

	$sq_enquiry = mysqlQuery("select * from enquiry_master where status!='Disabled'");
	...
	if($followup_count>0){
		...
		<tr>
			...
			<table width="85%" cellspacing="0" cellpadding="5" style="color: #888888;border: 1px solid #888888;margin: 0px auto;margin-top:20px; min-width: 100%;" role="presentation">
					<tr>
						<td colspan="6" style="text-align:left;border: 1px solid #888888;">Todays Followups</td>
					</tr>
					<tr>
					...
					while($row_enq = mysqli_fetch_assoc($sq_enquiry)){
						...
						$sq_emp = mysqli_fetch_assoc(mysqlQuery("select * from emp_master where emp_id='$row_enq[assigned_emp_id]'"));
						...
						if($sq_enquiry_entry['followup_status']=="Active" && date('Y-m-d', strtotime($sq_enquiry_entry['followup_date']))==$today){
							...
							$content1 .= '
								...
								<tr>
									...
									<td style="text-align:left;border: 1px solid #888888;">'.get_datetime_user($sq_enquiry_entry['followup_date']).'</td>
