...

{
	...
	$expense_type_count = mysqli_num_rows(mysqlQuery("select * from office_expense_type where expense_type='$expense_type'"));
	...
	$expense_type_id = mysqli_fetch_assoc(mysqlQuery("select max(expense_type_id) as max from office_expense_type"));

	$expense_type_id = $expense_type_id['max'] + 1;



	$sq = mysqlQuery("insert into office_expense_type (expense_type_id, expense_type, gl_id) value ('$expense_type_id', '$expense_type', '$gl_id')");
...

{
	...
	$expense_id = mysqli_fetch_assoc( mysqlQuery("select max(expense_id) as max from office_expense_master") );

	$expense_id = $expense_id['max'] + 1;	



	$sq = mysqlQuery("insert into office_expense_master ( expense_id, financial_year_id, expense_type_id, branch_admin_id, amount, expense_date, payment_mode, bank_name, transaction_id, bank_id, clearance_status, particular,purchase_date,branch_id ) values( '$expense_id', '$financial_year_id', '$expense_type_id', '$branch_admin_id', '$amount', '$expense_date', '$payment_mode', '$bank_name', '$transaction_id', '$bank_id', '$clearance_status', '$particular','$purchase_date','$branch' )");
...

{
	...
	$sq_expense_type_info = mysqli_fetch_assoc(mysqlQuery("select * from office_expense_type where expense_type_id='$expense_type_id'"));
...

{
	...
	$sq_payment_info = mysqli_fetch_assoc(mysqlQuery("select * from office_expense_master where expense_id='$expense_id'"));
	...
	$particular = addslashes($particular);
	$sq = mysqlQuery("update office_expense_master set financial_year_id='$financial_year_id', expense_type_id = '$expense_type_id', amount = '$amount', expense_date = '$expense_date', payment_mode='$payment_mode', bank_name='$bank_name', transaction_id='$transaction_id', bank_id='$bank_id', clearance_status='$clearance_status', particular = '$particular',purchase_date='$purchase_date',branch_id='$branch' where expense_id = '$expense_id'");
...

{
	...
	$sq_expense_type_info_old = mysqli_fetch_assoc(mysqlQuery("select * from office_expense_type where expense_type_id='$sq_payment_info[expense_type_id]'"));
