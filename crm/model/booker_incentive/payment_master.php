...
public function payment_save(){
  ...
  $sq_max = mysqli_fetch_assoc(mysqlQuery("select max(payment_id) as max from booker_incentive_payment_master"));

  $payment_id = $sq_max['max']+1;

  

  $sq_payment = mysqlQuery("insert into booker_incentive_payment_master(payment_id, emp_id, financial_year_id, branch_admin_id, payment_date, payment_mode, payment_amount, bank_name, transaction_id, bank_id, clearance_status, created_at) values ('$payment_id', '$emp_id', '$financial_year_id', '$branch_admin_id', '$payment_date', '$payment_mode', '$payment_amount', '$bank_name', '$transaction_id', '$bank_id', '$clearance_status', '$created_at')");
...

{
  ...
  $sq_payment_info = mysqli_fetch_assoc(mysqlQuery("select * from booker_incentive_payment_master where payment_id='$payment_id'"));
...

{
   ...
   $sq_car_rental = mysqli_fetch_assoc(mysqlQuery("select customer_id, total_fees from car_rental_booking where booking_id='$booking_id'"));

   $total_amount = $sq_car_rental['total_fees'];



   $sq_customer_info = mysqli_fetch_assoc(mysqlQuery("select email_id from customer_master where customer_id='$sq_car_rental[customer_id]'"));

   $email_id = $sq_customer_info['email_id'];



   $sq_total_amount = mysqli_fetch_assoc(mysqlQuery("select sum(payment_amount) as sum from car_rental_payment where booking_id='$booking_id'"));
