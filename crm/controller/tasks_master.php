...
public function tasks_master_save()
{
    ...
    $sq_task = mysqlQuery("insert into tasks_master ( task_id, emp_id, task_name, due_date, remind, remind_due_date, remind_by, task_type, task_type_field_id, task_status, created_at ) values ( '$task_id', '$assign_to', '$task_name', '$due_date', '$remind', '$remind_due_date', '$remind_by', '$task_type', '$task_type_field_id', '$task_status', '$created_at' )");
