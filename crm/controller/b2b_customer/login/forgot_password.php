...
$username=mysqlREString($_POST['user_name']);
...
$row_count=mysqli_num_rows(mysqlQuery("select * from b2b_registration where username='$username' and active_flag!='Inactive' and approval_status='Approved' and agent_code='$agent_code'"));
if($row_count>0){
    $sq_query=mysqli_fetch_assoc(mysqlQuery("select * from b2b_registration where username='$username' and active_flag!='Inactive' and approval_status='Approved' and agent_code='$agent_code'"));
