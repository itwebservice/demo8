...
$train_from_location_arr = ($_POST['train_from_location_arr']!='')?$_POST['train_from_location_arr']:[];
...
$plane_from_location_arr = ($_POST['plane_from_location_arr']!='')?$_POST['plane_from_location_arr']:[];
...
$day_program_arr = ($_POST['day_program_arr']!='')?$_POST['day_program_arr']:[];
...
$route_arr = ($_POST['route_arr']!='')?$_POST['route_arr']:[];
$cabin_arr = $_POST['cabin_arr'];

//$city_name_arr = $_POST['city_name_arr'];
$city_name_arr = ($_POST['city_name_arr']!='')?$_POST['city_name_arr']:[];
