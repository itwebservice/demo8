	...
	DateFormatter.prototype = {
		...
		parseFormat: function (vChar, vDate) {
			...
			fmt = {
				 ...
				 */
				c: function () {
					return 'Y-m-d\\TH:iP'.replace(backspace, doFormat);
				},
				/**
				 * RFC 2822 date
				 * @return {string}
				 */
				r: function () {
					return 'D, d M Y H:i O'.replace(backspace, doFormat);
				},
				/**
...
; (function (factory) {
	...
	$.datetimepicker = {
		...
		RFC_2822: 'D, d M Y H:i O',
		ATOM: 'Y-m-d\TH:iP',
		ISO_8601: 'Y-m-d\TH:iO',
		RFC_822: 'D, d M y H:i O',
		RFC_850: 'l, d-M-y H:i T',
		RFC_1036: 'D, d M y H:i O',
		RFC_1123: 'D, d M Y H:i O',
		RSS: 'D, d M Y H:i O',
		W3C: 'Y-m-d\TH:iP'
	};
