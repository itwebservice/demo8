        ...
        <input type="hidden" id="timing_slots" value='<?= json_encode($timing_slots) ?>'/>
            <div class="c-travellerDtls container-iPad">
                <div class="row c-infoRow">
                    ...
                    <div class="col-md-4 col-sm-6 for-iPad">
                        <div class="form-group">
                            <input type="number" minlength='10' maxlength='14' class="infoRow_txtbox" placeholder="*Contact Number" id="contact_no" name="contact_no" title="Enter Contact Number" data-toggle="tooltip" required />
                        </div>
                    </div>
                </div>
                <hr/>
