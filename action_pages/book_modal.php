    ...
    <div class="modal-dialog modal-lg" style="max-width:1300px" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" onclick=""><span aria-hidden="true">&times;</span></button>
            </div>
...
<script>
    ...
    function get_service_tax_main(result,cust_state) {
        //////////////////////////////
    ...
    function get_tax(state_id,total_cost1,travel_type){
        ...
        var applied_taxes = rules && get_service_tax_main(rules,cust_state);
    ...
    $(function() {
        $('#frm_pdf_save').validate({
            ...
            submitHandler: function(form) {
                ...
                var guest_arr = [];
                guest_arr.push({
                    'adult': adult_info_arr,
                    'chwob': chwob_info_arr,
                    'chwb': chwb_info_arr,
                    'infant': infant_info_arr,
                    'extra_bed': extrab_info_arr
                });
